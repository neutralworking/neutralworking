...
Fran Pastor projects primarily as a CM with a `—` lean. The strongest database support comes from Discipline, Close Range, and Composure.
...
- Best-fit role is [[metodista]] Metodista with model support score `35`.
