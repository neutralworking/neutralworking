...
category: players
tags: [CD, Helsingborgs IF, Sweden, Target]
updated: 2026-04-18
source: compiled
confidence: high
summary: CD at Helsingborgs IF. Archetype: Target.
person_id: 8454
backlinks: [target, helsingborgs-if]
---
...
Andreas Granqvist projects primarily as a CD with a `Target` lean. The strongest database support comes from Marking, Heading, and Long Range.
...
- Most bankable strengths show up in Marking, Heading, and Long Range.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Marking, Heading, and Long Range.
