...
V. Kostov projects primarily as a CF with a `Striker-Creator` lean. The strongest database support comes from Through Balls, Carries, and Threat.
...
- Most bankable strengths show up in Through Balls, Carries, and Threat.

## In Possession

- Ball-value indicators lean on Through Balls, Carries, and Threat.
- Style traits point toward Direct and Patient in possession.
