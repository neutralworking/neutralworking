...
source: compiled
confidence: high
summary: CM at Sporting Cristal. Archetype: None.
person_id: 28046
...
Jesús Pretell projects primarily as a CM with a `None` lean. The strongest database support comes from Aggression, Communication, and Concentration.

## Role Fit

- Best-fit role is `Playmaker` with model support score `24`.
