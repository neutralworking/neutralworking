...
S. Jovanović projects primarily as a AM with a `Creator-Striker` lean. The strongest database support comes from Aggression, Pressing, and Pass Accuracy.
...
- Most bankable strengths show up in Aggression, Pressing, and Pass Accuracy.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Aggression, Pressing, and Pass Accuracy.
