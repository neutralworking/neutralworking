...
Young English striker with decent physical attributes and work rate but inconsistent finishing and limited game intelligence. Currently a prospect rather than a near-term contributor at this level.

## Role Fit

- Primary archetype leans toward `Sprinter` behaviour from a `CF` base.
- Most bankable strengths show up in Pace, Acceleration, and Close Range.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Pace, Acceleration, and Close Range.
