...
Dario Espinola projects primarily as a CM with a `None` lean. The strongest database support comes from Take Ons, Flair, and Discipline.

## Role Fit

- Best-fit role is `Mezzala` with model support score `25`.
