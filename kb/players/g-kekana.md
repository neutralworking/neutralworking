...
title: G. Kekana
category: players
tags: [CM, Mamelodi Sundowns FC, Striker-Creator]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at Mamelodi Sundowns FC. Archetype: Striker-Creator.
person_id: 27658
backlinks: [striker, metodista, mamelodi-sundowns-fc]
---
...
G. Kekana projects primarily as a CM with a `Striker-Creator` lean. The strongest database support comes from Discipline, Communication, and Concentration.
...
- Best-fit role is [[metodista]] Metodista with model support score `22`.
- Primary archetype leans toward `Striker` behaviour from a `CM` base.
- Most bankable strengths show up in Discipline, Communication, and Concentration.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Discipline, Communication, and Concentration.
...
| Pass Accuracy | ████░░░░░░ 4/10 | One of the stronger current indicators for this profile at 4/10. |
