...
title: N. Byrne
category: players
tags: [CM, Charlotte FC, Destroyer]
updated: 2026-04-17
source: compiled
confidence: high
summary: CM at Charlotte FC. Archetype: Destroyer.
person_id: 24135
...
N. Byrne projects primarily as a CM with a `Destroyer` lean. The strongest database support comes from Discipline, Drive, and Technical.

## Role Fit

- Best-fit role is `Tuttocampista` with model support score `69`.
- Primary archetype leans toward `Destroyer` behaviour from a `CM` base.
- Most bankable strengths show up in Discipline, Drive, and Technical.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Discipline, Drive, and Technical.
