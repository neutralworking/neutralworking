...
title: Aníbal Godoy
category: players
tags: [CM, San Jose Earthquakes, Panama, Powerhouse]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at San Jose Earthquakes. Archetype: Powerhouse.
person_id: 8560
backlinks: [powerhouse, playmaker, san-jose-earthquakes]
---
...
Aníbal Godoy projects primarily as a CM with a `Powerhouse` lean. The strongest database support comes from Pass Accuracy, Physical, and Acceleration.
...
- Most bankable strengths show up in Pass Accuracy, Physical, and Acceleration.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Pass Accuracy, Physical, and Acceleration.
- Style traits point toward Trickery, Long Range Passing, and Tackling Ability in possession.
