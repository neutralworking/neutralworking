...
title: Jon Guridi
category: players
tags: [CM, Alavés, Spain, Dribbler]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at Alavés. Archetype: Dribbler.
person_id: 12837
backlinks: [dribbler, metodista, alaves]
---
...
Veteran midfielder with strong game intelligence and the ability to recycle possession effectively, though his mobility is clearly diminished and he can't dominate transitional moments. Useful as an experienced head in a midfield but no longer a creative driving force.
...
- Best-fit role is [[metodista]] Metodista with model support score `77`.
- Primary archetype leans toward `Dribbler` behaviour from a `CM` base.
- Most bankable strengths show up in Pass Range, Shielding, and Balance.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Pass Range, Shielding, and Balance.
