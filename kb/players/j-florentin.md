...
J. Florentín projects primarily as a CM with a `Cover-Striker` lean. The strongest database support comes from Stamina, Threat, and Close Range.
...
- Most bankable strengths show up in Stamina, Threat, and Close Range.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Stamina, Threat, and Close Range.
