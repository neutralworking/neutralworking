...
Aldo Parra projects primarily as a CF with a `—` lean. The strongest database support comes from Creativity, Discipline, and Duels.
...
- Best-fit role is [[target-forward]] Target Forward with model support score `50`.
