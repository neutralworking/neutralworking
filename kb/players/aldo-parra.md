...
Aldo Parra projects primarily as a CF with a `None` lean. The strongest database support comes from Creativity, Discipline, and Duels.

## Role Fit

- Best-fit role is `Target Forward` with model support score `50`.
