...
Darwin Guagua projects primarily as a CM with a `—` lean. The strongest database support comes from Close Range, Through Balls, and Creativity.
...
- Best-fit role is `Playmaker` with model support score `40`.
