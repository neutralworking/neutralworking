...
Issah Yakubu projects primarily as a CM with a `—` lean. The strongest database support comes from Vision, Close Range, and Composure.
...
- Most bankable strengths show up in Vision, Close Range, and Composure.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Vision, Close Range, and Composure.
