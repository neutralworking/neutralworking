...
Edwin Rivera projects primarily as a CM with a `—` lean. The strongest database support comes from Pass Accuracy, Aggression, and Awareness.
...
- Best-fit role is [[playmaker]] Playmaker with model support score `27`.
