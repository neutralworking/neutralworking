...
title: Jefferson
category: players
tags: [GK, Brazil, Engine]
updated: 2026-04-18
source: compiled
confidence: high
summary: GK at —. Archetype: Engine.
person_id: 3279
backlinks: [engine]
---
...
Jefferson projects primarily as a GK with a `Engine` lean. The strongest database support comes from Jumping, Acceleration, and Close Range.
...
- Primary archetype leans toward `Engine` behaviour from a `GK` base.
- Most bankable strengths show up in Jumping, Acceleration, and Close Range.
- Profile should be judged on shot-stopping, area command, and distribution fit to team style.

## In Possession

- Ball-value indicators lean on Jumping, Acceleration, and Close Range.
- Style traits point toward Speed Merchant and Aerial Threat in possession.
