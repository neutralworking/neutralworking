...
Jairo Rojas projects primarily as a CF with a `—` lean. The strongest database support comes from Pass Accuracy, Pressing, and Communication.
...
- Best-fit role is [[spearhead]] Spearhead with model support score `14`.
- Most bankable strengths show up in Pass Accuracy, Pressing, and Communication.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Pass Accuracy, Pressing, and Communication.
