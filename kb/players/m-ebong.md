...
title: M. Ebong
category: players
tags: [CM, CSKA, Striker]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at CSKA. Archetype: Striker.
person_id: 27000
backlinks: [striker, playmaker, cska]
---
...
M. Ebong projects primarily as a CM with a `Striker` lean. The strongest database support comes from Close Range, Threat, and Interceptions.
...
- Best-fit role is [[playmaker]] Playmaker with model support score `40`.
- Primary archetype leans toward `Striker` behaviour from a `CM` base.
- Most bankable strengths show up in Close Range, Threat, and Interceptions.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Close Range, Threat, and Interceptions.
