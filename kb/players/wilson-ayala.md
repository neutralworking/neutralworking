...
Wilson Ayala projects primarily as a CF with a `—` lean. The strongest database support comes from Discipline, Duels, and Long Range.
...
- Best-fit role is [[prima-punta]] Prima Punta with model support score `44`.
