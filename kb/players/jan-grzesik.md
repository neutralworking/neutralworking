...
person_id: 12372
backlinks: [powerhouse, centrale, radomiak-radom]
---
...
Jan Grzesik projects primarily as a CD with a `Powerhouse` lean. The strongest database support comes from Acceleration, Stamina, and Jumping.
...
- Best-fit role is [[centrale]] Centrale with model support score `75`.
