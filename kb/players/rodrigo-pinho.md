...
person_id: 16770
backlinks: [striker, seconda-punta, estrela-da-amadora]
---
...
Rodrigo Pinho projects primarily as a CF with a `Striker` lean. The strongest database support comes from Long Range, Close Range, and Penalties.
...
- Most bankable strengths show up in Long Range, Close Range, and Penalties.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Long Range, Close Range, and Penalties.
