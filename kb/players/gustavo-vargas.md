...
Gustavo Vargas projects primarily as a CD with a `—` lean. The strongest database support comes from Skills, Communication, and Concentration.
...
- Best-fit role is [[centrale]] Centrale with model support score `47`.
