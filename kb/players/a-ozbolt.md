...
person_id: 24348
backlinks: [striker, seconda-punta, levadiakos]
---
...
A. Ožbolt projects primarily as a CF with a `Striker` lean. The strongest database support comes from Close Range, Mid Range, and Threat.
