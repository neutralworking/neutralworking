...
person_id: 25977
backlinks: [destroyer, tuttocampista, botafogo]
---
...
Kauã Branco projects primarily as a CM with a `Destroyer-Striker` lean. The strongest database support comes from Blocking, Discipline, and Interceptions.
...
- Best-fit role is [[tuttocampista]] Tuttocampista with model support score `29`.
