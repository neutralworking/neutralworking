...
Abdessamad Mahir projects primarily as a CM with a `—` lean. The strongest database support comes from Close Range and Mid Range.
...
- Most bankable strengths show up in Close Range and Mid Range.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Close Range and Mid Range.
