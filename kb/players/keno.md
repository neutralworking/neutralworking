...
Keno projects primarily as a WM with a `Creator-Striker` lean. The strongest database support comes from Duels, Threat, and Composure.
...
- Most bankable strengths show up in Duels, Threat, and Composure.

## In Possession

- Ball-value indicators lean on Duels, Threat, and Composure.
