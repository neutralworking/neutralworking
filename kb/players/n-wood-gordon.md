...
N. Wood-Gordon projects primarily as a CM with a `Destroyer` lean. The strongest database support comes from Pass Accuracy, Blocking, and Awareness.
...
- Ball-value indicators lean on Pass Accuracy, Blocking, and Awareness.
