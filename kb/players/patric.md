...
title: Patric
category: players
tags: [CD, Lazio, Spain, Cover]
updated: 2026-04-17
source: compiled
confidence: high
summary: CD at Lazio. Archetype: Cover.
person_id: 16109
...
A centre-back with reasonable athleticism and basic positional sense, capable of handling the demands of Serie A midfield opposition but unremarkable technically. His distribution is rudimentary, and he'll rarely initiate play from the back; he's purely a defensive presence. At this level, he's a squad option—adequate for 15-20 appearances a season but not someone Lazio would prefer to build their defence around.

## Role Fit

- Best-fit role is `Centrale`.
- Primary archetype leans toward `Cover` behaviour from a `CD` base.
- Most bankable strengths show up in Interceptions, Jumping, and Reactions.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Interceptions, Jumping, and Reactions.
