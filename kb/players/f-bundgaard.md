...
F. Bundgaard projects primarily as a CF with a `Striker` lean. The strongest database support comes from Close Range, Pressing, and Aggression.
...
- Most bankable strengths show up in Close Range, Pressing, and Aggression.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Close Range, Pressing, and Aggression.
