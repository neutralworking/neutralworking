...
Richard Torales projects primarily as a CF with a `—` lean. The strongest database support comes from Discipline, Long Range, and Threat.
...
- Best-fit role is [[seconda-punta]] Seconda Punta with model support score `48`.
