...
Richard Torales projects primarily as a CF with a `None` lean. The strongest database support comes from Discipline, Long Range, and Threat.

## Role Fit

- Best-fit role is `Seconda Punta` with model support score `48`.
