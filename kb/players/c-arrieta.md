...
C. Arrieta projects primarily as a CM with a `Creator-Striker` lean. The strongest database support comes from Close Range, Discipline, and Through Balls.
...
- Most bankable strengths show up in Close Range, Discipline, and Through Balls.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Close Range, Discipline, and Through Balls.
