...
Wang Zhenghao projects primarily as a CM with a `Creator-Cover` lean. The strongest database support comes from Physical, Stamina, and Tackling.
...
- Most bankable strengths show up in Physical, Stamina, and Tackling.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Physical, Stamina, and Tackling.
