...
Alfredo Garcia projects primarily as a CF with a `—` lean. The strongest database support comes from Discipline, Close Range, and Communication.
...
- Best-fit role is [[seconda-punta]] Seconda Punta with model support score `30`.
