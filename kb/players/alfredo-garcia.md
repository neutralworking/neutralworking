...
Alfredo Garcia projects primarily as a CF with a `None` lean. The strongest database support comes from Discipline, Close Range, and Communication.

## Role Fit

- Best-fit role is `Seconda Punta` with model support score `30`.
