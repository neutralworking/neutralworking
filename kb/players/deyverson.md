...
title: Deyverson
category: players
tags: [CF, Fortaleza, Striker-Creator]
updated: 2026-04-19
source: compiled
confidence: high
summary: CF at Fortaleza. Archetype: Striker-Creator.
person_id: 22476
backlinks: [striker, prima-punta, fortaleza]
---
...
Deyverson projects primarily as a CF with a `Striker-Creator` lean. The strongest database support comes from Duels, Close Range, and Long Range.
...
- Best-fit role is [[prima-punta]] Prima Punta with model support score `74`.
- Primary archetype leans toward `Striker` behaviour from a `CF` base.
- Most bankable strengths show up in Duels, Close Range, and Long Range.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Duels, Close Range, and Long Range.
