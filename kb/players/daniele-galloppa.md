---
title: Daniele Galloppa
category: players
tags: [CM, Italy, Passer]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at —. Archetype: Passer.
person_id: 1572
...
Daniele Galloppa projects primarily as a CM with a `Passer` lean. The strongest database support comes from Pass Accuracy, Vision, and Acceleration.
...
- Most bankable strengths show up in Pass Accuracy, Vision, and Acceleration.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Pass Accuracy, Vision, and Acceleration.
