...
David Vujević projects primarily as a CD with a `Destroyer` lean. The strongest database support comes from Aerial Duels, Heading, and Aggression.
...
- Most bankable strengths show up in Aerial Duels, Heading, and Aggression.

## In Possession

- Ball-value indicators lean on Aerial Duels, Heading, and Aggression.
