...
Agustin Jara projects primarily as a CD with a `None` lean. The strongest database support comes from Blocking, Duels, and Marking.
...
- Most bankable strengths show up in Blocking, Duels, and Marking.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Blocking, Duels, and Marking.
