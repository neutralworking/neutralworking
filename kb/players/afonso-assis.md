...
Afonso Assis projects primarily as a CM with a `Cover-Striker` lean. The strongest database support comes from Close Range, Interceptions, and Pass Accuracy.
...
- Most bankable strengths show up in Close Range, Interceptions, and Pass Accuracy.

## In Possession

- Ball-value indicators lean on Close Range, Interceptions, and Pass Accuracy.
