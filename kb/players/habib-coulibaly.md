---
title: Habib Coulibaly
category: players
tags: [CM, TSV Hartberg, Destroyer]
updated: 2026-04-17
source: compiled
confidence: high
summary: CM at TSV Hartberg. Archetype: Destroyer.
person_id: 26416
backlinks: [destroyer, tsv-hartberg]
---
...
Habib Coulibaly projects primarily as a CM with a `Destroyer` lean. The strongest database support comes from Skills, Awareness, and Composure.

## Role Fit

- Best-fit role is `Metodista` with model support score `70`.
- Primary archetype leans toward `Destroyer` behaviour from a `CM` base.
- Most bankable strengths show up in Skills, Awareness, and Composure.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Skills, Awareness, and Composure.
