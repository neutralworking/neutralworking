...
title: I. Fiolić
category: players
tags: [CM, HNK Gorica, Striker-Creator]
updated: 2026-04-19
source: compiled
confidence: high
...
I. Fiolić projects primarily as a CM with a `Striker-Creator` lean. The strongest database support comes from Discipline, Long Range, and Threat.
...
- Most bankable strengths show up in Discipline, Long Range, and Threat.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Discipline, Long Range, and Threat.
