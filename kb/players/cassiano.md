...
title: Cassiano
category: players
tags: [CF, Casa Pia AC, Brazil, Creator]
updated: 2026-04-18
source: compiled
confidence: high
summary: CF at Casa Pia AC. Archetype: Creator.
person_id: 9438
backlinks: [creator, casa-pia-ac]
---
...
Midfielder with energy and willingness to cover ground, but tactically quite one-dimensional; mostly follows play rather than dictating it. Loses the ball too often in central areas when pressed and doesn't have the technical range to escape pressure. Useful squad rotation option for high-intensity, low-complexity matches.
...
- Best-fit role is `Target Forward` with model support score `67`.
- Primary archetype leans toward `Creator` behaviour from a `CF` base.
- Most bankable strengths show up in Aggression, Duels, and Close Range.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Aggression, Duels, and Close Range.
