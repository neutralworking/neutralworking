...
category: players
tags: [CM, Emirates Club, Spain, Dribbler-Controller]
updated: 2026-04-18
source: compiled
confidence: high
summary: CM at Emirates Club. Archetype: Dribbler-Controller.
person_id: 8482
backlinks: [dribbler, emirates-club]
---
...
Silk in motion — glided past opponents with close control and perfect body feints. Combined dribbling mastery with game intelligence to unlock the tightest defences.
...
- Best-fit role is `Mezzala` with model support score `93`.
- Primary archetype leans toward `Dribbler` behaviour from a `CM` base.
- Most bankable strengths show up in Anticipation, Composure, and First Touch.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Anticipation, Composure, and First Touch.
- Style traits point toward Dribble Artist, One Touch Play, and Tempo Controller in possession.
