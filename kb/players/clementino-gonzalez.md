...
Clementino Gonzalez projects primarily as a CF with a `—` lean. The strongest database support comes from Long Range, Duels, and Threat.
...
- Most bankable strengths show up in Long Range, Duels, and Threat.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Long Range, Duels, and Threat.
