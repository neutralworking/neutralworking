...
person_id: 26131
backlinks: [cover, tuttocampista, petrolul-ploiesti]
---
...
A. Dumitrescu projects primarily as a CM with a `Cover` lean. The strongest database support comes from Discipline, Close Range, and Drive.
...
- Most bankable strengths show up in Discipline, Close Range, and Drive.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Discipline, Close Range, and Drive.
