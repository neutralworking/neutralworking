...
L. Kocou projects primarily as a CM with a `—` lean. The strongest database support comes from Discipline, Composure, and Skills.
...
- Best-fit role is [[metodista]] Metodista with model support score `24`.
