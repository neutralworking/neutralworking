...
Euder Galdino da Silva projects primarily as a CM with a `Striker-Creator` lean. The strongest database support comes from Positioning, Discipline, and Drive.
...
- Best-fit role is `Tuttocampista` with model support score `33`.
...
- Most bankable strengths show up in Positioning, Discipline, and Drive.

## In Possession

- Ball-value indicators lean on Positioning, Discipline, and Drive.
