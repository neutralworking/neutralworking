...
title: R. Carrascal
category: players
tags: [CM, América de Cali, Creator-Destroyer]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at América de Cali. Archetype: Creator-Destroyer.
person_id: 21718
backlinks: [creator, mezzala, america-de-cali]
---
...
R. Carrascal projects primarily as a CM with a `Creator-Destroyer` lean. The strongest database support comes from Stamina, Creativity, and Threat.
...
- Most bankable strengths show up in Stamina, Creativity, and Threat.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Stamina, Creativity, and Threat.
...
- **Endurance** (physical) — severity 9/10
