...
Gabriel Sotomayor projects primarily as a CF with a `None` lean. The strongest database support comes from Close Range, Mid Range, and Composure.

## Role Fit

- Best-fit role is `Seconda Punta` with model support score `57`.
