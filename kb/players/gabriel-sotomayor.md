...
Gabriel Sotomayor projects primarily as a CF with a `—` lean. The strongest database support comes from Close Range, Mid Range, and Composure.
...
- Best-fit role is [[seconda-punta]] Seconda Punta with model support score `57`.
