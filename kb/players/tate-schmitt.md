...
title: Tate Schmitt
category: players
tags: [CD, Real Salt Lake, United States, Sprinter-Dribbler]
updated: 2026-04-17
source: compiled
confidence: high
summary: CD at Real Salt Lake. Archetype: Sprinter-Dribbler.
person_id: 17801
...
Tate Schmitt projects primarily as a CD with a `Sprinter-Dribbler` lean. The strongest database support comes from Long Range, Pace, and Physical.

## Role Fit

- Primary archetype leans toward `Sprinter` behaviour from a `CD` base.
- Most bankable strengths show up in Long Range, Pace, and Physical.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Long Range, Pace, and Physical.
