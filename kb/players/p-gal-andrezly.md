...
P. Gál-Andrezly projects primarily as a CM with a `Cover` lean. The strongest database support comes from Aggression, Concentration, and Discipline.

## Role Fit

- Best-fit role is `Tuttocampista` with model support score `70`.
- Primary archetype leans toward `Cover` behaviour from a `CM` base.
- Most bankable strengths show up in Aggression, Concentration, and Discipline.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Aggression, Concentration, and Discipline.
