...
Y. Díaz projects primarily as a CM with a `Destroyer-Striker` lean. The strongest database support comes from Discipline, Blocking, and Technical.
...
- Most bankable strengths show up in Discipline, Blocking, and Technical.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Discipline, Blocking, and Technical.
