...
person_id: 25091
backlinks: [destroyer, playmaker, nk-osijek]
---
...
S. Mkrtchyan projects primarily as a CM with a `Destroyer` lean. The strongest database support comes from Blocking, Aggression, and Duels.
...
- Most bankable strengths show up in Blocking, Aggression, and Duels.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Blocking, Aggression, and Duels.
