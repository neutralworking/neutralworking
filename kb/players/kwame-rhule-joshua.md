...
Kwame Rhule Joshua projects primarily as a CF with a `—` lean. The strongest database support comes from Close Range, First Touch, and Flair.
...
- Most bankable strengths show up in Close Range, First Touch, and Flair.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Close Range, First Touch, and Flair.
