...
Avellar projects primarily as a CM with a `Creator-Striker` lean. The strongest database support comes from Positioning, Take Ons, and Creativity.
...
- Best-fit role is `Playmaker` with model support score `43`.
