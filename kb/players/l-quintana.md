...
title: L. Quintana
category: players
tags: [CM, Cerro Porteño, Creator-Cover]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at Cerro Porteño. Archetype: Creator-Cover.
person_id: 27619
backlinks: [creator, tuttocampista, cerro-porteno]
---
...
L. Quintana projects primarily as a CM with a `Creator-Cover` lean. The strongest database support comes from Communication, Discipline, and Interceptions.
...
- Best-fit role is [[tuttocampista]] Tuttocampista with model support score `28`.
- Primary archetype leans toward `Creator` behaviour from a `CM` base.
- Most bankable strengths show up in Communication, Discipline, and Interceptions.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Communication, Discipline, and Interceptions.
