...
category: players
tags: [WD, Real Betis, Switzerland, Cover]
updated: 2026-04-19
source: compiled
confidence: high
summary: WD at Real Betis. Archetype: Cover.
person_id: 16615
backlinks: [cover, invertido, real-betis]
---
...
Swiss left-back in decline whose technical passing ability and set-piece delivery remain assets but whose defensive recovery pace and positioning are increasingly vulnerable. Useful veteran depth but not reliable for a consistent starting role.
...
- Best-fit role is [[invertido]] Invertido with model support score `69`.
- Primary archetype leans toward `Cover` behaviour from a `WD` base.
- Most bankable strengths show up in Crossing, First Touch, and Long Range.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Crossing, First Touch, and Long Range.
