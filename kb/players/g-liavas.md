...
G. Liavas projects primarily as a CM with a `Destroyer` lean. The strongest database support comes from Aggression, Awareness, and Pass Accuracy.
...
- Most bankable strengths show up in Aggression, Awareness, and Pass Accuracy.

## In Possession

- Ball-value indicators lean on Aggression, Awareness, and Pass Accuracy.
