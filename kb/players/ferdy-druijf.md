...
title: Ferdy Druijf
category: players
tags: [CF, PEC Zwolle, Netherlands, Striker-Target]
updated: 2026-04-18
source: compiled
confidence: high
summary: CF at PEC Zwolle. Archetype: Striker-Target.
person_id: 10991
backlinks: [striker, pec-zwolle]
---
...
Ferdy Druijf projects primarily as a CF with a `Striker-Target` lean. The strongest database support comes from Physical, Penalties, and First Touch.

## Role Fit

- Primary archetype leans toward `Striker` behaviour from a `CF` base.
- Most bankable strengths show up in Physical, Penalties, and First Touch.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Physical, Penalties, and First Touch.
