...
L. Sødal projects primarily as a CM with a `Destroyer` lean. The strongest database support comes from Aggression, Tackling, and Intensity.
...
- Most bankable strengths show up in Aggression, Tackling, and Intensity.

## In Possession

- Ball-value indicators lean on Aggression, Tackling, and Intensity.
