...
title: Eldar Ćivić
category: players
tags: [CM, FC Spartak Trnava, Bosnia and Herzegovina, Sprinter]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at FC Spartak Trnava. Archetype: Sprinter.
person_id: 10525
backlinks: [sprinter, fc-spartak-trnava]
---
...
Eldar Ćivić projects primarily as a CM with a `Sprinter` lean. The strongest database support comes from Acceleration, Aggression, and Crossing.
...
- Most bankable strengths show up in Acceleration, Aggression, and Crossing.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Acceleration, Aggression, and Crossing.
