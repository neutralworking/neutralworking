...
title: J. Une-Larsson
category: players
tags: [CM, Djurgårdens IF, Powerhouse-Destroyer]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at Djurgårdens IF. Archetype: Powerhouse-Destroyer.
person_id: 23968
backlinks: [powerhouse, tuttocampista, djurgardens-if]
---
...
J. Une-Larsson projects primarily as a CM with a `Powerhouse-Destroyer` lean. The strongest database support comes from Shielding, Jumping, and Heading.
...
- Most bankable strengths show up in Shielding, Jumping, and Heading.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Shielding, Jumping, and Heading.
