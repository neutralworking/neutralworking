...
S. Gueulette projects primarily as a CD with a `Cover` lean. The strongest database support comes from Aggression, Tackling, and Marking.
...
- Most bankable strengths show up in Aggression, Tackling, and Marking.

## In Possession

- Ball-value indicators lean on Aggression, Tackling, and Marking.
