...
title: Lóránd Pászka
category: players
tags: [CD, Ferencváros, Sprinter]
updated: 2026-04-19
source: compiled
confidence: high
summary: CD at Ferencváros. Archetype: Sprinter.
person_id: 14005
backlinks: [sprinter, centrale, ferencvaros]
---
...
Lóránd Pászka projects primarily as a CD with a `Sprinter` lean. The strongest database support comes from Acceleration, Shielding, and Crossing.
...
- Most bankable strengths show up in Acceleration, Shielding, and Crossing.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Acceleration, Shielding, and Crossing.
