...
M. Konatar projects primarily as a CM with a `Cover-Striker` lean. The strongest database support comes from Discipline, Duels, and Skills.

## Role Fit

- Best-fit role is `Tuttocampista` with model support score `72`.
- Primary archetype leans toward `Cover` behaviour from a `CM` base.
- Most bankable strengths show up in Discipline, Duels, and Skills.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Discipline, Duels, and Skills.
