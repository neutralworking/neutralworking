...
person_id: 23776
backlinks: [destroyer, playmaker, western-sydney-wanderers]
---
...
A. Pantazopoulos projects primarily as a CM with a `Destroyer-Striker` lean. The strongest database support comes from Blocking, Discipline, and Threat.
...
- Most bankable strengths show up in Blocking, Discipline, and Threat.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Blocking, Discipline, and Threat.
