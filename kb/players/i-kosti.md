...
person_id: 23791
backlinks: [creator, inverted-winger, levadiakos]
---
...
I. Kosti projects primarily as a WF with a `Creator` lean. The strongest database support comes from Flair, Pass Accuracy, and Aggression.
...
- Most bankable strengths show up in Flair, Pass Accuracy, and Aggression.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Flair, Pass Accuracy, and Aggression.
