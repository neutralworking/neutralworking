...
Jhon Velasco projects primarily as a CD with a `None` lean. The strongest database support comes from Discipline, Drive, and Pressing.

## Role Fit

- Best-fit role is `Centrale`.
- Most bankable strengths show up in Discipline, Drive, and Pressing.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Discipline, Drive, and Pressing.
