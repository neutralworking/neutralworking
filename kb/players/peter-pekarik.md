...
title: Peter Pekarík
category: players
tags: [WD, Hertha BSC, Slovakia, Creator]
updated: 2026-04-19
source: compiled
confidence: high
summary: WD at Hertha BSC. Archetype: Creator.
person_id: 16278
backlinks: [creator, fullback, hertha-bsc]
---
...
- Best-fit role is [[fullback]] Fullback with model support score `43`.
- Primary archetype leans toward `Creator` behaviour from a `WD` base.
- Most bankable strengths show up in Interceptions, Clearances, and Blocking.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Interceptions, Clearances, and Blocking.
