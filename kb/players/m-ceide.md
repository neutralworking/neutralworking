...
M. Ceïde projects primarily as a CM with a `Destroyer` lean. The strongest database support comes from Discipline, Blocking, and Pressing.
...
- Most bankable strengths show up in Discipline, Blocking, and Pressing.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Discipline, Blocking, and Pressing.
