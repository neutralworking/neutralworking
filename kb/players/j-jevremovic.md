...
title: J. Jevremović
category: players
tags: [CM, Striker-Creator]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at —. Archetype: Striker-Creator.
person_id: 24190
backlinks: [striker, playmaker]
---
...
J. Jevremović projects primarily as a CM with a `Striker-Creator` lean. The strongest database support comes from Aggression, Tackling, and Close Range.
...
- Best-fit role is [[playmaker]] Playmaker with model support score `45`.
- Primary archetype leans toward `Striker` behaviour from a `CM` base.
- Most bankable strengths show up in Aggression, Tackling, and Close Range.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Aggression, Tackling, and Close Range.
