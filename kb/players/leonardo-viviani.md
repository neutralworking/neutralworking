...
Leonardo Viviani projects primarily as a CF with a `None` lean. The strongest database support comes from Pass Accuracy, Threat, and Composure.

## Role Fit

- Best-fit role is `Falso Nove` with model support score `63`.
- Most bankable strengths show up in Pass Accuracy, Threat, and Composure.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Pass Accuracy, Threat, and Composure.
