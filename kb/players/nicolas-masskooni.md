...
Nicolas Masskooni projects primarily as a CM with a `—` lean. The strongest database support comes from Flair, Interceptions, and Skills.
...
- Best-fit role is [[tuttocampista]] Tuttocampista with model support score `54`.
- Most bankable strengths show up in Flair, Interceptions, and Skills.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Flair, Interceptions, and Skills.
