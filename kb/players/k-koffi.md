...
K. Koffi projects primarily as a CM with a `None` lean. The strongest database support comes from Discipline, Composure, and Skills.

## Role Fit

- Best-fit role is `Metodista` with model support score `33`.
