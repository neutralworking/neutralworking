...
K. Koffi projects primarily as a CM with a `—` lean. The strongest database support comes from Discipline, Composure, and Skills.
...
- Best-fit role is [[metodista]] Metodista with model support score `33`.
- Most bankable strengths show up in Discipline, Composure, and Skills.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Discipline, Composure, and Skills.
