...
title: Ján Greguš
category: players
tags: [CM, Minnesota United FC, Slovakia, Powerhouse-Dribbler]
updated: 2026-04-18
source: compiled
confidence: high
...
Ján Greguš projects primarily as a CM with a `Powerhouse-Dribbler` lean. The strongest database support comes from Stamina, Aggression, and Composure.
...
- Most bankable strengths show up in Stamina, Aggression, and Composure.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Stamina, Aggression, and Composure.
