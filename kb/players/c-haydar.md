...
person_id: 26489
backlinks: [destroyer, tuttocampista, atletico-nacional]
---
...
C. Haydar projects primarily as a CM with a `Destroyer-Striker` lean. The strongest database support comes from Blocking, Technical, and Awareness.
...
- Most bankable strengths show up in Blocking, Technical, and Awareness.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Blocking, Technical, and Awareness.
