...
source: compiled
confidence: high
summary: CM at Independiente de La Chorrera. Archetype: —.
person_id: 28440
backlinks: [metodista, independiente-de-la-chorrera]
---
...
Marlon Ávila projects primarily as a CM with a `—` lean. The strongest database support comes from Discipline, Composure, and Communication.
...
- Best-fit role is [[metodista]] Metodista with model support score `26`.
