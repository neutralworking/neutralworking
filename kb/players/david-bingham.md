...
David Bingham projects primarily as a GK with a `GK` lean. The strongest database support comes from Pass Range, Physical, and Close Range.
...
- Most bankable strengths show up in Pass Range, Physical, and Close Range.
- Profile should be judged on shot-stopping, area command, and distribution fit to team style.

## In Possession

- Ball-value indicators lean on Pass Range, Physical, and Close Range.
