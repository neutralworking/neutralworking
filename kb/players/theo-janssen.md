...
title: Theo Janssen
category: players
tags: [CM, Vitesse, Passer]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at Vitesse. Archetype: Passer.
person_id: 7065
backlinks: [passer, playmaker, vitesse]
---
...
Theo Janssen projects primarily as a CM with a `Passer` lean. The strongest database support comes from Pass Accuracy, Vision, and Long Range.
...
- Most bankable strengths show up in Pass Accuracy, Vision, and Long Range.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Pass Accuracy, Vision, and Long Range.
