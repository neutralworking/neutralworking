...
Lee Chang-Min projects primarily as a CM with a `Creator-Striker` lean. The strongest database support comes from Threat, Long Range, and Through Balls.
...
- Most bankable strengths show up in Threat, Long Range, and Through Balls.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Threat, Long Range, and Through Balls.
