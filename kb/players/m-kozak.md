...
title: M. Kozák
category: players
tags: [CF, Teplice, Striker]
updated: 2026-04-17
source: compiled
confidence: high
summary: CF at Teplice. Archetype: Striker.
person_id: 24404
backlinks: [striker, teplice]
---
...
M. Kozák projects primarily as a CF with a `Striker` lean. The strongest database support comes from Mid Range, Carries, and Close Range.

## Role Fit

- Best-fit role is `Prima Punta` with model support score `69`.
- Primary archetype leans toward `Striker` behaviour from a `CF` base.
- Most bankable strengths show up in Mid Range, Carries, and Close Range.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Mid Range, Carries, and Close Range.
