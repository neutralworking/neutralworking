...
Muhammad Hussain projects primarily as a CM with a `—` lean. The strongest database support comes from Pass Range, Aerial Duels, and Heading.
...
- Most bankable strengths show up in Pass Range, Aerial Duels, and Heading.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Pass Range, Aerial Duels, and Heading.
