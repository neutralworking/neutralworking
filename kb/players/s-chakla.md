...
title: S. Chakla
category: players
tags: [CM, Larisa Ael, Destroyer]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at Larisa Ael. Archetype: Destroyer.
person_id: 25847
backlinks: [destroyer, metodista, larisa-ael]
---
...
S. Chakla projects primarily as a CM with a `Destroyer` lean. The strongest database support comes from Blocking, Aggression, and Close Range.
...
- Best-fit role is [[metodista]] Metodista with model support score `70`.
- Primary archetype leans toward `Destroyer` behaviour from a `CM` base.
- Most bankable strengths show up in Blocking, Aggression, and Close Range.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Blocking, Aggression, and Close Range.
