...
Ali Abdullah Hazzazi projects primarily as a CM with a `Destroyer-Creator` lean. The strongest database support comes from Aggression, Tackling, and Technical.
...
- Most bankable strengths show up in Aggression, Tackling, and Technical.

## In Possession

- Ball-value indicators lean on Aggression, Tackling, and Technical.
