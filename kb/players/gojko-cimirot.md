...
title: Gojko Cimirot
category: players
tags: [CM, Standard Liège, Bosnia & Herzegovina, Powerhouse]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at Standard Liège. Archetype: Powerhouse.
person_id: 11468
backlinks: [powerhouse, tuttocampista, standard-liege]
---
...
Gojko Cimirot projects primarily as a CM with a `Powerhouse` lean. The strongest database support comes from Pass Accuracy, Balance, and Composure.
...
- Most bankable strengths show up in Pass Accuracy, Balance, and Composure.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Pass Accuracy, Balance, and Composure.
