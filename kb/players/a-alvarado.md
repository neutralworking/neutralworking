...
title: A. Alvarado
category: players
tags: [DM, San Diego Wave, Cover]
updated: 2026-04-19
source: compiled
confidence: high
summary: DM at San Diego Wave. Archetype: Cover.
person_id: 25773
backlinks: [cover, segundo-volante, san-diego-wave]
---
...
A. Alvarado projects primarily as a DM with a `Cover` lean. The strongest database support comes from Intensity, Aggression, and Pressing.
...
- Best-fit role is [[segundo-volante]] Segundo Volante with model support score `70`.
- Primary archetype leans toward `Cover` behaviour from a `DM` base.
- Tactical fit is strongest when the game asks for High Press.
- Most bankable strengths show up in Intensity, Aggression, and Pressing.

## In Possession

- Ball-value indicators lean on Intensity, Aggression, and Pressing.
