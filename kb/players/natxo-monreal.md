...
Natxo Monreal projects primarily as a WD with a `Sprinter` lean. The strongest database support comes from Interceptions, Marking, and Pass Accuracy.
