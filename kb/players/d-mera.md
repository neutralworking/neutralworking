...
title: D. Mera
category: players
tags: [CM, AD Unión Magdalena, Sprinter-Dribbler]
updated: 2026-04-17
source: compiled
confidence: high
summary: CM at AD Unión Magdalena. Archetype: Sprinter-Dribbler.
person_id: 25531
backlinks: [sprinter, ad-union-magdalena]
---
...
D. Mera projects primarily as a CM with a `Sprinter-Dribbler` lean. The strongest database support comes from Physical, Shielding, and Jumping.

## Role Fit

- Best-fit role is `Playmaker` with model support score `69`.
- Primary archetype leans toward `Sprinter` behaviour from a `CM` base.
- Most bankable strengths show up in Physical, Shielding, and Jumping.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Physical, Shielding, and Jumping.
