...
S. PirgiÄ projects primarily as a CM with a `Creator-Striker` lean. The strongest database support comes from Flair, Blocking, and Mid Range.
...
- Most bankable strengths show up in Flair, Blocking, and Mid Range.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Flair, Blocking, and Mid Range.
