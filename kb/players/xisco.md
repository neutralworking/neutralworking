...
Xisco projects primarily as a CF with a `Target` lean. The strongest database support comes from Aerial Duels, Acceleration, and Long Range.

## Role Fit

- Best-fit role is `Target Forward`.
- Primary archetype leans toward `Target` behaviour from a `CF` base.
- Most bankable strengths show up in Aerial Duels, Acceleration, and Long Range.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Aerial Duels, Acceleration, and Long Range.
