...
F. Krstić projects primarily as a CM with a `Cover-Creator` lean. The strongest database support comes from Flair, Interceptions, and Aggression.
...
- Most bankable strengths show up in Flair, Interceptions, and Aggression.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Flair, Interceptions, and Aggression.
