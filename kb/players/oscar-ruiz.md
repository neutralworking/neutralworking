...
Oscar Ruiz projects primarily as a CF with a `None` lean. The strongest database support comes from Discipline, Pressing, and Creativity.

## Role Fit

- Best-fit role is `Falso Nove` with model support score `41`.
