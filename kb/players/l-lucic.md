...
L. Lučić projects primarily as a CM with a `Creator-Destroyer` lean. The strongest database support comes from Blocking, Creativity, and Tackling.
...
- Most bankable strengths show up in Blocking, Creativity, and Tackling.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Blocking, Creativity, and Tackling.
