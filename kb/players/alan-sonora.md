...
Alan Sonora projects primarily as a CM with a `—` lean. The strongest database support comes from Flair, Pass Range, and Skills.
...
- Most bankable strengths show up in Flair, Pass Range, and Skills.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Flair, Pass Range, and Skills.
