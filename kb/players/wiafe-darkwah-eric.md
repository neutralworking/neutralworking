...
Wiafe Darkwah Eric projects primarily as a CF with a `—` lean. The strongest database support comes from Pass Range, Positioning, and Shielding.
...
- Most bankable strengths show up in Pass Range, Positioning, and Shielding.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Pass Range, Positioning, and Shielding.
...
|---|---|---|---|---|
| Attribute model | Chief Scout DB | 2026-04-19 | High | 14 graded indicators available. |
