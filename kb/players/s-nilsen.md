...
S. Nilsen projects primarily as a CM with a `Creator-Striker` lean. The strongest database support comes from Through Balls, Vision, and Close Range.
...
- Most bankable strengths show up in Through Balls, Vision, and Close Range.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Through Balls, Vision, and Close Range.
