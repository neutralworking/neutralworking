...
Estivel Moreira projects primarily as a CM with a `—` lean. The strongest database support comes from Composure, Discipline, and Awareness.
...
- Best-fit role is [[metodista]] Metodista with model support score `41`.
- Most bankable strengths show up in Composure, Discipline, and Awareness.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Composure, Discipline, and Awareness.
