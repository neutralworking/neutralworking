...
K. Čabrajić projects primarily as a CM with a `Cover-Creator` lean. The strongest database support comes from Pressing, Flair, and Interceptions.

## Role Fit

- Best-fit role is `Tuttocampista` with model support score `70`.
- Primary archetype leans toward `Cover` behaviour from a `CM` base.
- Most bankable strengths show up in Pressing, Flair, and Interceptions.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Pressing, Flair, and Interceptions.
