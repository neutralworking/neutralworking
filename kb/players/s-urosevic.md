...
S. Urošević projects primarily as a CM with a `Cover-Striker` lean. The strongest database support comes from Aggression, Tackling, and Discipline.

## Role Fit

- Best-fit role is `Playmaker` with model support score `71`.
- Primary archetype leans toward `Cover` behaviour from a `CM` base.
- Most bankable strengths show up in Aggression, Tackling, and Discipline.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Aggression, Tackling, and Discipline.
