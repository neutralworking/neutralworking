...
Alan Ledesma projects primarily as a CM with a `—` lean. The strongest database support comes from Threat, Aggression, and Long Range.
...
- Best-fit role is [[playmaker]] Playmaker with model support score `25`.
- Most bankable strengths show up in Threat, Aggression, and Long Range.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Threat, Aggression, and Long Range.
