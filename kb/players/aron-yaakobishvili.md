---
title: Áron Yaakobishvili
category: players
tags: [GK, Barcelona, Hungary, GK]
updated: 2026-04-17
source: compiled
confidence: high
summary: GK at Barcelona. Archetype: GK.
person_id: 8720
backlinks: [gk, barcelona]
---
...
Young Hungarian goalkeeper getting minutes in a competitive La Liga environment but without the consistent playing time needed to move beyond prospect status. He has the fundamentals, but goalkeeper development at this level requires regular action, and he's not yet the primary choice.

## Role Fit

- Primary archetype leans toward `GK` behaviour from a `GK` base.
- Most bankable strengths show up in Jumping, Physical, and Pass Accuracy.
- Profile should be judged on shot-stopping, area command, and distribution fit to team style.

## In Possession

- Ball-value indicators lean on Jumping, Physical, and Pass Accuracy.
