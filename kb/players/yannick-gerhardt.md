...
category: players
tags: [CM, Wolfsburg, Germany, Cover]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at Wolfsburg. Archetype: Cover.
person_id: 18611
backlinks: [cover, tuttocampista, wolfsburg]
---
...
Versatile, tactically disciplined midfielder with decent passing range but limited athleticism and creative spark. Reliable squad option for Bundesliga football but showing signs of age-related decline.
...
- Best-fit role is [[tuttocampista]] Tuttocampista with model support score `52`.
- Primary archetype leans toward `Cover` behaviour from a `CM` base.
- Most bankable strengths show up in First Touch, Reactions, and Movement.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on First Touch, Reactions, and Movement.
