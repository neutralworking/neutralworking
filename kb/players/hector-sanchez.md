...
Hector Sanchez projects primarily as a CM with a `—` lean. The strongest database support comes from Close Range, Creativity, and Flair.
...
- Best-fit role is [[playmaker]] Playmaker with model support score `35`.
