...
F. González projects primarily as a CM with a `Cover-Creator` lean. The strongest database support comes from Concentration, Threat, and Through Balls.

## Role Fit

- Best-fit role is `Playmaker` with model support score `69`.
- Primary archetype leans toward `Cover` behaviour from a `CM` base.
- Most bankable strengths show up in Concentration, Threat, and Through Balls.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Concentration, Threat, and Through Balls.
