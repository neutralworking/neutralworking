...
category: players
tags: [CF, Ipswich Town, Ireland, Striker]
updated: 2026-04-19
source: compiled
confidence: high
...
Jonathan Walters projects primarily as a CF with a `Striker` lean. The strongest database support comes from Heading, Acceleration, and First Touch.
...
- Most bankable strengths show up in Heading, Acceleration, and First Touch.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Heading, Acceleration, and First Touch.
