...
person_id: 23842
backlinks: [destroyer, metodista, slovacko]
---
...
F. Vaško projects primarily as a CM with a `Destroyer` lean. The strongest database support comes from Blocking, Pass Accuracy, and Aggression.
...
- Most bankable strengths show up in Blocking, Pass Accuracy, and Aggression.

## In Possession

- Ball-value indicators lean on Blocking, Pass Accuracy, and Aggression.
