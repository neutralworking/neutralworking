...
L. Letenay projects primarily as a WM with a `Striker-Creator` lean. The strongest database support comes from Close Range, Threat, and Long Range.
...
- Most bankable strengths show up in Close Range, Threat, and Long Range.

## In Possession

- Ball-value indicators lean on Close Range, Threat, and Long Range.
