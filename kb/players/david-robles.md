...
David Robles projects primarily as a CD with a `—` lean. The strongest database support comes from Blocking, Drive, and Duels.
...
- Most bankable strengths show up in Blocking, Drive, and Duels.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Blocking, Drive, and Duels.
