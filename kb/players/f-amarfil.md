...
title: F. Amarfil
category: players
tags: [CM, Destroyer-Creator]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at —. Archetype: Destroyer-Creator.
person_id: 21941
...
F. Amarfil projects primarily as a CM with a `Destroyer-Creator` lean. The strongest database support comes from Stamina, Aggression, and Blocking.
...
- Most bankable strengths show up in Stamina, Aggression, and Blocking.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Stamina, Aggression, and Blocking.
