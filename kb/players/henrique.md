...
Henrique projects primarily as a CF with a `Sprinter` lean. The strongest database support comes from First Touch, Volleys, and Pass Range.
...
- Most bankable strengths show up in First Touch, Volleys, and Pass Range.

## In Possession

- Ball-value indicators lean on First Touch, Volleys, and Pass Range.
