---
title: Jardiel Maciel Libertino da Silva
category: players
tags: [CF, Grêmio, Creator]
updated: 2026-04-19
source: compiled
confidence: high
summary: CF at Grêmio. Archetype: Creator.
person_id: 25487
backlinks: [creator, shadow-striker, gremio]
---
...
Jardiel Maciel Libertino da Silva projects primarily as a CF with a `Creator` lean. The strongest database support comes from Carries, Discipline, and Threat.
...
- Best-fit role is [[shadow-striker]] Shadow Striker with model support score `36`.
- Primary archetype leans toward `Creator` behaviour from a `CF` base.
- Most bankable strengths show up in Carries, Discipline, and Threat.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Carries, Discipline, and Threat.
