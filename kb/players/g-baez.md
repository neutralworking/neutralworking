...
G. Báez projects primarily as a CM with a `Creator-Destroyer` lean. The strongest database support comes from Creativity, Mental, and Technical.
...
- Most bankable strengths show up in Creativity, Mental, and Technical.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Creativity, Mental, and Technical.
