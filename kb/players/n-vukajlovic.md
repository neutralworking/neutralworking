...
title: N. Vukajlović
category: players
tags: [CM, Napredak, Cover-Creator]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at Napredak. Archetype: Cover-Creator.
person_id: 24754
backlinks: [cover, tuttocampista, napredak]
---
...
N. Vukajlović projects primarily as a CM with a `Cover-Creator` lean. The strongest database support comes from Interceptions, Long Range, and Aggression.
...
- Most bankable strengths show up in Interceptions, Long Range, and Aggression.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Interceptions, Long Range, and Aggression.
...
- **Inconsistent** (behavioral) — severity 6/10
