...
title: Åke Johansson
category: players
tags: [CF, Mjällby AIF, Striker]
updated: 2026-04-17
source: compiled
confidence: high
summary: CF at Mjällby AIF. Archetype: Striker.
person_id: 19761
backlinks: [striker, mjallby-aif]
---
...
Åke Johansson projects primarily as a CF with a `Striker` lean. The strongest database support comes from Aggression, Carries, and Close Range.

## Role Fit

- Best-fit role is `Shadow Striker` with model support score `69`.
- Primary archetype leans toward `Striker` behaviour from a `CF` base.
- Most bankable strengths show up in Aggression, Carries, and Close Range.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Aggression, Carries, and Close Range.
