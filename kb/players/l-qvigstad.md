...
L. Qvigstad projects primarily as a CM with a `Destroyer` lean. The strongest database support comes from Tackling, Aggression, and Close Range.
...
- Most bankable strengths show up in Tackling, Aggression, and Close Range.

## In Possession

- Ball-value indicators lean on Tackling, Aggression, and Close Range.
