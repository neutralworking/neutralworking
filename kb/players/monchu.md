...
Monchu projects primarily as a CM with a `Destroyer-Creator` lean. The strongest database support comes from Threat, Aggression, and Close Range.
...
- Most bankable strengths show up in Threat, Aggression, and Close Range.

## In Possession

- Ball-value indicators lean on Threat, Aggression, and Close Range.
