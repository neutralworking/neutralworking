...
person_id: 22086
backlinks: [sprinter, ball-winner, defensa-y-justicia]
---
...
K. Gutiérrez projects primarily as a CM with a `Sprinter-Dribbler` lean. The strongest database support comes from Shielding, Acceleration, and Balance.
