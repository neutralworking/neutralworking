...
Pablo Pedraza projects primarily as a CD with a `—` lean. The strongest database support comes from Pass Accuracy, Skills, and Blocking.
...
- Most bankable strengths show up in Pass Accuracy, Skills, and Blocking.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Pass Accuracy, Skills, and Blocking.
