...
person_id: 21829
backlinks: [dribbler, wide-playmaker, gent]
---
...
A. Lescano projects primarily as a WM with a `Dribbler-Sprinter` lean. The strongest database support comes from First Touch, Balance, and Jumping.
...
- Most bankable strengths show up in First Touch, Balance, and Jumping.

## In Possession

- Ball-value indicators lean on First Touch, Balance, and Jumping.
