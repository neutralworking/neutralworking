...
Kasey Keller projects primarily as a GK with a `GK` lean. The strongest database support comes from Reactions, Pass Range, and Positioning.
...
- Most bankable strengths show up in Reactions, Pass Range, and Positioning.
- Profile should be judged on shot-stopping, area command, and distribution fit to team style.

## In Possession

- Ball-value indicators lean on Reactions, Pass Range, and Positioning.
