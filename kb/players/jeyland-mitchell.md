...
Jeyland Mitchell projects primarily as a CD with a `None` lean. The strongest database support comes from Shielding, Duels, and Tackling.

## Role Fit

- Best-fit role is `Stopper`.
- Most bankable strengths show up in Shielding, Duels, and Tackling.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Shielding, Duels, and Tackling.
