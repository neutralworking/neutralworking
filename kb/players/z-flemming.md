...
title: Z. Flemming
category: players
tags: [CF, Burnley, Powerhouse-Striker]
updated: 2026-04-17
source: compiled
confidence: high
summary: CF at Burnley. Archetype: Powerhouse-Striker.
person_id: 20727
...
Z. Flemming projects primarily as a CF with a `Powerhouse-Striker` lean. The strongest database support comes from Jumping, Stamina, and First Touch.

## Role Fit

- Best-fit role is `Prima Punta` with model support score `75`.
...
- Style traits point toward Two Footed, Direct, and Long Throws in possession.
