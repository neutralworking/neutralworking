...
Gustavo Cristaldo projects primarily as a CM with a `—` lean. The strongest database support comes from Long Range, Creativity, and Duels.
...
- Most bankable strengths show up in Long Range, Creativity, and Duels.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Long Range, Creativity, and Duels.
