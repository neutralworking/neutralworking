...
G. Tegüé projects primarily as a CM with a `Striker-Destroyer` lean. The strongest database support comes from Blocking, Discipline, and Technical.
...
- Most bankable strengths show up in Blocking, Discipline, and Technical.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Blocking, Discipline, and Technical.
