...
Kevin Pereira projects primarily as a CF with a `None` lean. The strongest database support comes from Pace, Acceleration, and Drive.
...
- Most bankable strengths show up in Pace, Acceleration, and Drive.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Pace, Acceleration, and Drive.
