...
Cesar Benitez projects primarily as a CD with a `None` lean. The strongest database support comes from Drive, Skills, and Communication.

## Role Fit

- Best-fit role is `Centrale` with model support score `37`.
