...
Cesar Benitez projects primarily as a CD with a `—` lean. The strongest database support comes from Drive, Skills, and Communication.
...
- Best-fit role is [[centrale]] Centrale with model support score `37`.
