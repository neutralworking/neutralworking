...
person_id: 11076
backlinks: [creator, pivote, burnley]
---
...
- Best-fit role is [[pivote]] Pivote.
- Primary archetype leans toward `Creator` behaviour from a `DM` base.
- Most bankable strengths show up in Physical, Stamina, and Technical.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Physical, Stamina, and Technical.
...
| Decisions | ██████░░░░ 6/10 | One of the stronger current indicators for this profile at 6/10. |
