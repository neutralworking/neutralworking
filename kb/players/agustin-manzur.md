...
Agustin Manzur projects primarily as a CM with a `—` lean. The strongest database support comes from Threat, Through Balls, and Concentration.
...
- Most bankable strengths show up in Threat, Through Balls, and Concentration.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Threat, Through Balls, and Concentration.
