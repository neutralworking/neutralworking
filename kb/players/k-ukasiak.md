...
K. Łukasiak projects primarily as a CM with a `Destroyer-Creator` lean. The strongest database support comes from Aggression, Discipline, and Duels.

## Role Fit

- Best-fit role is `Tuttocampista` with model support score `72`.
- Primary archetype leans toward `Destroyer` behaviour from a `CM` base.
- Most bankable strengths show up in Aggression, Discipline, and Duels.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Aggression, Discipline, and Duels.
