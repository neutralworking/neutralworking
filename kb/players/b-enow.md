...
B. Enow projects primarily as a CM with a `Cover-Striker` lean. The strongest database support comes from Intensity, Aggression, and Interceptions.
...
- Most bankable strengths show up in Intensity, Aggression, and Interceptions.

## In Possession

- Ball-value indicators lean on Intensity, Aggression, and Interceptions.
