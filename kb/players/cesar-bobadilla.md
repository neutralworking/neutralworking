...
Cesar Bobadilla projects primarily as a CM with a `—` lean. The strongest database support comes from Composure, Discipline, and Aggression.
...
- Best-fit role is [[metodista]] Metodista with model support score `40`.
- Most bankable strengths show up in Composure, Discipline, and Aggression.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Composure, Discipline, and Aggression.
