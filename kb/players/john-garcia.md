...
John Garcia projects primarily as a CM with a `—` lean. The strongest database support comes from Long Range, Take Ons, and Threat.
...
- Most bankable strengths show up in Long Range, Take Ons, and Threat.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Long Range, Take Ons, and Threat.
