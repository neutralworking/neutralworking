...
R. Messi projects primarily as a WM with a `Striker-Creator` lean. The strongest database support comes from Threat, Creativity, and Take Ons.
...
- Most bankable strengths show up in Threat, Creativity, and Take Ons.

## In Possession

- Ball-value indicators lean on Threat, Creativity, and Take Ons.
