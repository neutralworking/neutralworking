...
title: L. Škaričić
category: players
tags: [CM, NK Varaždin, Destroyer-Striker]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at NK Varaždin. Archetype: Destroyer-Striker.
person_id: 24280
...
L. Škaričić projects primarily as a CM with a `Destroyer-Striker` lean. The strongest database support comes from Close Range, Awareness, and Blocking.
...
- Most bankable strengths show up in Close Range, Awareness, and Blocking.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Close Range, Awareness, and Blocking.
