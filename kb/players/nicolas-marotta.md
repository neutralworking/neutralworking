...
Nicolas Marotta projects primarily as a CD with a `None` lean. The strongest database support comes from Concentration, Skills, and Blocking.

## Role Fit

- Best-fit role is `Centrale` with model support score `43`.
