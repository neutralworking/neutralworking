...
L. Garate projects primarily as a CF with a `Striker-Creator` lean. The strongest database support comes from Aggression, Duels, and Carries.
...
- Most bankable strengths show up in Aggression, Duels, and Carries.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Aggression, Duels, and Carries.
