...
Jesus Llano projects primarily as a CM with a `—` lean. The strongest database support comes from Close Range, Mid Range, and Concentration.
...
- Best-fit role is [[playmaker]] Playmaker with model support score `28`.
- Most bankable strengths show up in Close Range, Mid Range, and Concentration.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Close Range, Mid Range, and Concentration.
