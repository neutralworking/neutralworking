...
Sebastian Mila projects primarily as a WD with a `Passer` lean. The strongest database support comes from Pass Accuracy, Pass Range, and Vision.
...
- Most bankable strengths show up in Pass Accuracy, Pass Range, and Vision.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Pass Accuracy, Pass Range, and Vision.
- Style traits point toward Ball Progressor in possession.
