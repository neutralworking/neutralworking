...
Daan Dierckx projects primarily as a CM with a `Destroyer` lean. The strongest database support comes from Physical, Heading, and Pace.
...
- Most bankable strengths show up in Physical, Heading, and Pace.

## In Possession

- Ball-value indicators lean on Physical, Heading, and Pace.
