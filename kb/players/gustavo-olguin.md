...
Gustavo Olguin projects primarily as a CD with a `None` lean. The strongest database support comes from Blocking, Discipline, and Drive.

## Role Fit

- Best-fit role is `Centrale`.
- Most bankable strengths show up in Blocking, Discipline, and Drive.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Blocking, Discipline, and Drive.
