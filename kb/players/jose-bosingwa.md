...
José Bosingwa projects primarily as a WD with a `Sprinter` lean. The strongest database support comes from Acceleration, Pass Accuracy, and Pass Range.
