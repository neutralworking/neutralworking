...
title: A. Shestyuk
category: players
tags: [CF, Radnički Niš, Striker]
updated: 2026-04-19
source: compiled
confidence: high
summary: CF at Radnički Niš. Archetype: Striker.
person_id: 26970
backlinks: [striker, prima-punta, radnicki-nis]
---
...
A. Shestyuk projects primarily as a CF with a `Striker` lean. The strongest database support comes from Close Range, Mid Range, and Communication.
...
- Best-fit role is [[prima-punta]] Prima Punta with model support score `40`.
- Primary archetype leans toward `Striker` behaviour from a `CF` base.
- Most bankable strengths show up in Close Range, Mid Range, and Communication.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Close Range, Mid Range, and Communication.
