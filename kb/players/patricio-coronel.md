...
Patricio Coronel projects primarily as a CF with a `—` lean. The strongest database support comes from Discipline, Pass Accuracy, and Skills.
...
- Best-fit role is [[falso-nove]] Falso Nove with model support score `28`.
- Most bankable strengths show up in Discipline, Pass Accuracy, and Skills.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Discipline, Pass Accuracy, and Skills.
