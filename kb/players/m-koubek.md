...
person_id: 24234
backlinks: [creator, target-forward, fc-fastav-zlin]
---
...
M. Koubek projects primarily as a CF with a `Creator-Striker` lean. The strongest database support comes from Aggression, Duels, and Vision.
...
- Most bankable strengths show up in Aggression, Duels, and Vision.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Aggression, Duels, and Vision.
