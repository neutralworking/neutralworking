---
title: Paolo De Ceglie
category: players
tags: [WD, Juventus, Italy, Sprinter-Striker]
updated: 2026-04-18
source: compiled
confidence: high
summary: WD at Juventus. Archetype: Sprinter-Striker.
person_id: 5673
backlinks: [sprinter, juventus]
---
...
Paolo De Ceglie projects primarily as a WD with a `Sprinter-Striker` lean. The strongest database support comes from Pace, First Touch, and Interceptions.

## Role Fit

- Best-fit role is `Wing-back`.
- Primary archetype leans toward `Sprinter` behaviour from a `WD` base.
- Most bankable strengths show up in Pace, First Touch, and Interceptions.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Pace, First Touch, and Interceptions.
- Style traits point toward Speed Merchant and Pace in possession.
