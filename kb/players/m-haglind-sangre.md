...
M. Haglind-Sangré projects primarily as a CM with a `Destroyer-Creator` lean. The strongest database support comes from Blocking, Discipline, and Composure.
...
- Most bankable strengths show up in Blocking, Discipline, and Composure.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Blocking, Discipline, and Composure.
