...
Sergio Mendoza projects primarily as a CD with a `None` lean. The strongest database support comes from Tackling, Interceptions, and Pressing.

## Role Fit

- Best-fit role is `Stopper`.
- Most bankable strengths show up in Tackling, Interceptions, and Pressing.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Tackling, Interceptions, and Pressing.
