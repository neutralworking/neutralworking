...
Cesar Villagra projects primarily as a CF with a `None` lean. The strongest database support comes from Discipline, Pass Range, and Through Balls.

## Role Fit

- Best-fit role is `Falso Nove` with model support score `24`.
