...
Cristian Valencia projects primarily as a CD with a `None` lean. The strongest database support comes from Skills, Composure, and Interceptions.

## Role Fit

- Best-fit role is `Sweeper`.
- Most bankable strengths show up in Skills, Composure, and Interceptions.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Skills, Composure, and Interceptions.
