...
category: players
tags: [CF, RKC Waalwijk, Netherlands, Target]
updated: 2026-04-19
source: compiled
confidence: high
summary: CF at RKC Waalwijk. Archetype: Target.
person_id: 15128
backlinks: [target, target-forward, rkc-waalwijk]
---
...
Michiel Kramer projects primarily as a CF with a `Target` lean. The strongest database support comes from Aggression, Jumping, and Movement.
...
- Most bankable strengths show up in Aggression, Jumping, and Movement.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Aggression, Jumping, and Movement.
