...
title: Bram Castro
category: players
tags: [AM, KV Oostende, Cover-Striker]
updated: 2026-04-18
source: compiled
confidence: high
summary: AM at KV Oostende. Archetype: Cover-Striker.
person_id: 899
backlinks: [cover, kv-oostende]
---
...
Bram Castro projects primarily as a AM with a `Cover-Striker` lean. The strongest database support comes from Pass Range, Positioning, and Reactions.

## Role Fit

- Best-fit role is `Trequartista`.
- Primary archetype leans toward `Cover` behaviour from a `AM` base.
- Most bankable strengths show up in Pass Range, Positioning, and Reactions.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Pass Range, Positioning, and Reactions.
