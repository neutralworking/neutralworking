...
- Best-fit role is [[metodista]] Metodista with model support score `94`.
- Primary archetype leans toward `Striker` behaviour from a `CM` base.
- Tactical fit is strongest when the game asks for Long Range Threat and Captain Leader.
- Most bankable strengths show up in Communication, Leadership, and Long Range.

## In Possession

- Ball-value indicators lean on Communication, Leadership, and Long Range.

## Out of Possession

- Defensive or transition evidence is strongest in Long Range Threat and Captain Leader.
