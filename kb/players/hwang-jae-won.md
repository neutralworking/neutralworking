...
person_id: 21818
backlinks: [creator, tuttocampista, daegu-fc]
---
...
Hwang Jae-Won projects primarily as a CM with a `Creator-Cover` lean. The strongest database support comes from Drive, Pressing, and Technical.
...
- Most bankable strengths show up in Drive, Pressing, and Technical.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Drive, Pressing, and Technical.
