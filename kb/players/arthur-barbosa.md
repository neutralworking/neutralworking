...
category: players
tags: [CM, Fortaleza, Creator]
updated: 2026-04-18
source: compiled
confidence: high
summary: CM at Fortaleza. Archetype: Creator.
person_id: 25643
...
Arthur Barbosa projects primarily as a CM with a `Creator` lean. The strongest database support comes from Creativity, Discipline, and Drive.
...
- Best-fit role is `Mezzala` with model support score `22`.
- Primary archetype leans toward `Creator` behaviour from a `CM` base.
- Most bankable strengths show up in Creativity, Discipline, and Drive.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Creativity, Discipline, and Drive.
