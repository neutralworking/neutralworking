...
Gabriel Aguayo projects primarily as a CF with a `—` lean. The strongest database support comes from Close Range, Duels, and Creativity.
...
- Most bankable strengths show up in Close Range, Duels, and Creativity.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Close Range, Duels, and Creativity.
