...
Hugo Martinez projects primarily as a CM with a `—` lean. The strongest database support comes from Intensity, Positioning, and Stamina.
...
- Best-fit role is `Tuttocampista` with model support score `55`.
- Most bankable strengths show up in Intensity, Positioning, and Stamina.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Intensity, Positioning, and Stamina.
