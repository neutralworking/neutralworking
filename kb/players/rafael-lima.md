...
person_id: 24543
backlinks: [striker, playmaker, braga]
---
...
Rafael Lima projects primarily as a CM with a `Striker-Creator` lean. The strongest database support comes from Take Ons, Creativity, and Drive.
...
- Best-fit role is [[playmaker]] Playmaker with model support score `31`.
- Primary archetype leans toward `Striker` behaviour from a `CM` base.
- Most bankable strengths show up in Take Ons, Creativity, and Drive.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Take Ons, Creativity, and Drive.
