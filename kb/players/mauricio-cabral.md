...
Mauricio Cabral projects primarily as a CF with a `—` lean. The strongest database support comes from Skills, Aggression, and Pass Accuracy.
...
- Best-fit role is [[target-forward]] Target Forward with model support score `26`.
- Most bankable strengths show up in Skills, Aggression, and Pass Accuracy.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Skills, Aggression, and Pass Accuracy.
