...
Mauricio Cabral projects primarily as a CF with a `None` lean. The strongest database support comes from Skills, Aggression, and Pass Accuracy.

## Role Fit

- Best-fit role is `Target Forward` with model support score `26`.
