...
Alexandru Ioniţă projects primarily as a CF with a `Sprinter` lean. The strongest database support comes from Acceleration, Aerial Duels, and Pace.
...
- Best-fit role is [[target-forward]] Target Forward with model support score `66`.
