...
Jose Espinola projects primarily as a CM with a `—` lean. The strongest database support comes from Awareness, Interceptions, and Blocking.
...
- Best-fit role is [[metodista]] Metodista with model support score `55`.
- Most bankable strengths show up in Awareness, Interceptions, and Blocking.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Awareness, Interceptions, and Blocking.
