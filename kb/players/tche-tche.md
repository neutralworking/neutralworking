...
person_id: 22186
backlinks: [striker, playmaker, vasco-da-gama]
---
...
Tchê Tchê projects primarily as a CM with a `Striker-Creator` lean. The strongest database support comes from Composure, Flair, and Pass Accuracy.
...
- Most bankable strengths show up in Composure, Flair, and Pass Accuracy.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Composure, Flair, and Pass Accuracy.
