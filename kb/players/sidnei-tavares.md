---
title: Sidnei Tavares
category: players
tags: [CM, Blackburn Rovers, Creator-Cover]
updated: 2026-04-17
source: compiled
confidence: high
summary: CM at Blackburn Rovers. Archetype: Creator-Cover.
person_id: 21219
...
Sidnei Tavares projects primarily as a CM with a `Creator-Cover` lean. The strongest database support comes from Pass Accuracy, Vision, and Aggression.

## Role Fit

- Best-fit role is `Playmaker` with model support score `69`.
- Primary archetype leans toward `Creator` behaviour from a `CM` base.
- Most bankable strengths show up in Pass Accuracy, Vision, and Aggression.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Pass Accuracy, Vision, and Aggression.
