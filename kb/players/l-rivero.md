...
L. Rivero projects primarily as a CM with a `Destroyer-Striker` lean. The strongest database support comes from Discipline, Close Range, and Blocking.

## Role Fit

- Best-fit role is `Tuttocampista` with model support score `70`.
- Primary archetype leans toward `Destroyer` behaviour from a `CM` base.
- Most bankable strengths show up in Discipline, Close Range, and Blocking.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Discipline, Close Range, and Blocking.
