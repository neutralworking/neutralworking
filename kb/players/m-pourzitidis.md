...
title: M. Pourzitídis
category: players
tags: [CM, Dukla Praha, Destroyer-Striker]
updated: 2026-04-17
source: compiled
confidence: high
summary: CM at Dukla Praha. Archetype: Destroyer-Striker.
person_id: 23822
...
M. Pourzitídis projects primarily as a CM with a `Destroyer-Striker` lean. The strongest database support comes from Blocking, Awareness, and Close Range.

## Role Fit

- Best-fit role is `Tuttocampista` with model support score `70`.
- Primary archetype leans toward `Destroyer` behaviour from a `CM` base.
- Most bankable strengths show up in Blocking, Awareness, and Close Range.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Blocking, Awareness, and Close Range.
