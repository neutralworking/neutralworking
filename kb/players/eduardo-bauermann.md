...
Eduardo Bauermann projects primarily as a CM with a `Destroyer` lean. The strongest database support comes from Stamina, Positioning, and Blocking.
...
- Most bankable strengths show up in Stamina, Positioning, and Blocking.

## In Possession

- Ball-value indicators lean on Stamina, Positioning, and Blocking.
