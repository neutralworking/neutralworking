---
title: Darren Pratley
category: players
tags: [CM, Bolton Wanderers, England, Target-Passer]
updated: 2026-04-18
source: compiled
confidence: high
summary: CM at Bolton Wanderers. Archetype: Target-Passer.
person_id: 10044
backlinks: [target, bolton-wanderers]
---
...
Darren Pratley projects primarily as a CM with a `Target-Passer` lean. The strongest database support comes from Aggression, Skills, and Aerial Duels.

## Role Fit

- Primary archetype leans toward `Target` behaviour from a `CM` base.
- Most bankable strengths show up in Aggression, Skills, and Aerial Duels.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Aggression, Skills, and Aerial Duels.
