---
title: César Gelabert
category: players
tags: [CM, Toulouse, Spain, Dribbler-Sprinter]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at Toulouse. Archetype: Dribbler-Sprinter.
person_id: 9471
backlinks: [dribbler, playmaker, toulouse]
---
...
César Gelabert projects primarily as a CM with a `Dribbler-Sprinter` lean. The strongest database support comes from Vision, Acceleration, and Pace.
...
- Most bankable strengths show up in Vision, Acceleration, and Pace.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Vision, Acceleration, and Pace.
- Style traits point toward Two Footed, Finishing, and Long Range Passing in possession.
