...
title: R. Bidounga
category: players
tags: [CM, PFC Lokomotiv Sofia 1929, Striker-Cover]
updated: 2026-04-17
source: compiled
confidence: high
summary: CM at PFC Lokomotiv Sofia 1929. Archetype: Striker-Cover.
person_id: 24019
backlinks: [striker, pfc-lokomotiv-sofia-1929]
---
...
R. Bidounga projects primarily as a CM with a `Striker-Cover` lean. The strongest database support comes from Close Range, Interceptions, and Mid Range.

## Role Fit

- Best-fit role is `Playmaker` with model support score `70`.
- Primary archetype leans toward `Striker` behaviour from a `CM` base.
- Most bankable strengths show up in Close Range, Interceptions, and Mid Range.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Close Range, Interceptions, and Mid Range.
