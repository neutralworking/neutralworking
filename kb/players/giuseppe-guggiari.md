...
Giuseppe Guggiari projects primarily as a CF with a `None` lean. The strongest database support comes from Communication, Concentration, and Drive.

## Role Fit

- Best-fit role is `Seconda Punta` with model support score `19`.
