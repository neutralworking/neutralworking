...
N. Strunck projects primarily as a CM with a `Striker-Creator` lean. The strongest database support comes from Mid Range, Close Range, and Composure.
...
- Most bankable strengths show up in Mid Range, Close Range, and Composure.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Mid Range, Close Range, and Composure.
