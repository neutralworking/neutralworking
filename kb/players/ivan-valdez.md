...
Ivan Valdez projects primarily as a CF with a `—` lean. The strongest database support comes from Pass Accuracy, Intensity, and Close Range.
...
- Most bankable strengths show up in Pass Accuracy, Intensity, and Close Range.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Pass Accuracy, Intensity, and Close Range.
