---
title: Orest Lebedenko
category: players
tags: [CD, Vitória Guimarães, Ukraine, Cover]
updated: 2026-04-19
source: compiled
confidence: high
summary: CD at Vitória Guimarães. Archetype: Cover.
person_id: 15966
backlinks: [cover, colossus, vitoria-guimaraes]
---
...
Orest Lebedenko projects primarily as a CD with a `Cover` lean. The strongest database support comes from Aggression, Skills, and Tackling.
...
- Best-fit role is [[colossus]] Colossus with model support score `69`.
- Primary archetype leans toward `Cover` behaviour from a `CD` base.
- Most bankable strengths show up in Aggression, Skills, and Tackling.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Aggression, Skills, and Tackling.
...
| Marking | █████░░░░░ 5/10 | One of the stronger current indicators for this profile at 5/10. |
