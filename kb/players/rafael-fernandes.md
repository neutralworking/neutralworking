...
category: players
tags: [CD, Lille, Portugal, Destroyer]
updated: 2026-04-18
source: compiled
confidence: high
summary: CD at Lille. Archetype: Destroyer.
person_id: 16424
...
A centre-back who's performed well for a Portuguese side at 23, showing composure on the ball and solid reading of the game in a structured system. His test now is adapting to the demands of Ligue 1's greater intensity — he can occasionally be caught in transition against quicker strikers, and he'll need to add more physicality to dominate aerially.

## Role Fit

- Primary archetype leans toward `Destroyer` behaviour from a `CD` base.
- Most bankable strengths show up in Tackling, Aggression, and Heading.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Tackling, Aggression, and Heading.
