...
Adrian Brizuela projects primarily as a CD with a `None` lean. The strongest database support comes from Skills, Discipline, and Communication.

## Role Fit

- Best-fit role is `Centrale` with model support score `39`.
- Most bankable strengths show up in Skills, Discipline, and Communication.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Skills, Discipline, and Communication.
