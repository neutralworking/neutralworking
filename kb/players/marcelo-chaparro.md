...
Marcelo Chaparro projects primarily as a CM with a `—` lean. The strongest database support comes from Awareness, Interceptions, and Creativity.
...
- Best-fit role is [[playmaker]] Playmaker with model support score `52`.
- Most bankable strengths show up in Awareness, Interceptions, and Creativity.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Awareness, Interceptions, and Creativity.
