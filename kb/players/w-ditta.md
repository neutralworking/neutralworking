...
W. Ditta projects primarily as a CM with a `Destroyer-Creator` lean. The strongest database support comes from Stamina, Blocking, and Flair.
...
- Most bankable strengths show up in Stamina, Blocking, and Flair.

## In Possession

- Ball-value indicators lean on Stamina, Blocking, and Flair.
