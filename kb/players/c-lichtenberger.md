---
title: C. Lichtenberger
category: players
tags: [WM, Grazer AK, Creator-Powerhouse]
updated: 2026-04-18
source: compiled
confidence: high
summary: WM at Grazer AK. Archetype: Creator-Powerhouse.
person_id: 23683
backlinks: [creator, grazer-ak]
---
...
C. Lichtenberger projects primarily as a WM with a `Creator-Powerhouse` lean. The strongest database support comes from Shielding, Acceleration, and Movement.
...
- Best-fit role is `False Winger` with model support score `72`.
- Primary archetype leans toward `Creator` behaviour from a `WM` base.
- Most bankable strengths show up in Shielding, Acceleration, and Movement.

## In Possession

- Ball-value indicators lean on Shielding, Acceleration, and Movement.
