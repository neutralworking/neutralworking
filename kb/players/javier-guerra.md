...
Javier Guerra projects primarily as a CD with a `None` lean. The strongest database support comes from Skills, Creativity, and Pass Accuracy.

## Role Fit

- Best-fit role is `Colossus`.
- Most bankable strengths show up in Skills, Creativity, and Pass Accuracy.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Skills, Creativity, and Pass Accuracy.
