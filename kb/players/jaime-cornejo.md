...
Jaime Cornejo projects primarily as a CM with a `—` lean. The strongest database support comes from Pass Range, Tackling, and Through Balls.
...
- Style traits point toward Skill Moves, Long Range Passing, and Long Throws in possession.
