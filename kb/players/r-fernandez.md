...
person_id: 22443
backlinks: [destroyer, mezzala, club-tijuana]
---
...
R. Fernández projects primarily as a CM with a `Destroyer-Creator` lean. The strongest database support comes from Aggression, Tackling, and Blocking.
...
- Most bankable strengths show up in Aggression, Tackling, and Blocking.

## In Possession

- Ball-value indicators lean on Aggression, Tackling, and Blocking.
