...
M. Mijailović projects primarily as a CM with a `Cover` lean. The strongest database support comes from Awareness, Blocking, and Flair.
...
- Most bankable strengths show up in Awareness, Blocking, and Flair.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Awareness, Blocking, and Flair.
