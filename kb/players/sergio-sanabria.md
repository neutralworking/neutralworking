...
Sergio Sanabria projects primarily as a CM with a `None` lean. The strongest database support comes from Aggression, Awareness, and Concentration.

## Role Fit

- Best-fit role is `Ball Winner` with model support score `42`.
- Most bankable strengths show up in Aggression, Awareness, and Concentration.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Aggression, Awareness, and Concentration.
