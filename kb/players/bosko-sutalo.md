...
title: Boško Šutalo
category: players
tags: [CD, Cracovia Kraków, Cover]
updated: 2026-04-18
source: compiled
confidence: high
summary: CD at Cracovia Kraków. Archetype: Cover.
person_id: 9120
backlinks: [cover, cracovia-krakow]
---
...
Boško Šutalo projects primarily as a CD with a `Cover` lean. The strongest database support comes from Balance, Jumping, and Long Range.
...
- Best-fit role is `Sweeper` with model support score `73`.
