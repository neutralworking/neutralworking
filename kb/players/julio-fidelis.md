...
title: Julio Fidelis
category: players
tags: [CM, Fluminense, Striker-Cover]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at Fluminense. Archetype: Striker-Cover.
person_id: 25495
backlinks: [striker, mezzala, fluminense]
---
...
Julio Fidelis projects primarily as a CM with a `Striker-Cover` lean. The strongest database support comes from Take Ons, Pressing, and Threat.
...
- Best-fit role is [[mezzala]] Mezzala with model support score `36`.
- Primary archetype leans toward `Striker` behaviour from a `CM` base.
- Most bankable strengths show up in Take Ons, Pressing, and Threat.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Take Ons, Pressing, and Threat.
