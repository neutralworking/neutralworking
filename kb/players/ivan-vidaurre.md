...
Ivan Vidaurre projects primarily as a CM with a `—` lean. The strongest database support comes from Blocking, Pass Accuracy, and Aggression.
...
- Best-fit role is `Metodista` with model support score `25`.
