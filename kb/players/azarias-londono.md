---
title: Azarias Londoño
category: players
tags: [CM, Universidad Católica, Panama]
updated: 2026-04-17
source: compiled
confidence: high
summary: CM at Universidad Católica. Archetype: None.
person_id: 28432
...
Azarias Londoño projects primarily as a CM with a `None` lean. The strongest database support comes from Creativity, Intensity, and Threat.

## Role Fit

- Best-fit role is `Playmaker` with model support score `66`.
- Most bankable strengths show up in Creativity, Intensity, and Threat.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Creativity, Intensity, and Threat.
