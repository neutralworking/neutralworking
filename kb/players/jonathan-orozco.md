...
category: players
tags: [CM, St. Louis City SC, Destroyer-Striker]
updated: 2026-04-18
source: compiled
confidence: high
summary: CM at St. Louis City SC. Archetype: Destroyer-Striker.
person_id: 3535
backlinks: [destroyer, ball-winner, st-louis-city-sc]
---
...
Jonathan Orozco projects primarily as a CM with a `Destroyer-Striker` lean. The strongest database support comes from Pass Range, Reactions, and Positioning.
...
- Best-fit role is [[ball-winner]] Ball Winner with model support score `61`.
- Primary archetype leans toward `Destroyer` behaviour from a `CM` base.
- Tactical fit is strongest when the game asks for Build Up Contributor and High Press.
- Most bankable strengths show up in Pass Range, Reactions, and Positioning.

## In Possession

- Ball-value indicators lean on Pass Range, Reactions, and Positioning.
