...
Constantin Dragoș Albu projects primarily as a CM with a `Destroyer-Striker` lean. The strongest database support comes from Discipline, Long Range, and Blocking.
...
- Most bankable strengths show up in Discipline, Long Range, and Blocking.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Discipline, Long Range, and Blocking.
