...
Centre-back with solid positional sense and decent aerial command, capable enough in a back two. However, he's not comfortable with the ball at his feet and lacks the pace to cover lateral movements consistently; adequate for Mainz's level but would struggle against pressing attacks.

## Role Fit

- Best-fit role is `Centrale`.
- Primary archetype leans toward `Destroyer` behaviour from a `CD` base.
- Most bankable strengths show up in Acceleration, Interceptions, and Jumping.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Acceleration, Interceptions, and Jumping.
