...
title: T. Silverholt
category: players
tags: [CF, IF Elfsborg, Striker-Creator]
updated: 2026-04-19
source: compiled
confidence: high
summary: CF at IF Elfsborg. Archetype: Striker-Creator.
person_id: 23175
backlinks: [striker, seconda-punta, if-elfsborg]
---
...
T. Silverholt projects primarily as a CF with a `Striker-Creator` lean. The strongest database support comes from Close Range, Concentration, and Discipline.
...
- Most bankable strengths show up in Close Range, Concentration, and Discipline.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Close Range, Concentration, and Discipline.
