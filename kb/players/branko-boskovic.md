...
Branko Bošković projects primarily as a CM with a `Dribbler` lean. The strongest database support comes from First Touch, Pass Range, and Aerial Duels.
...
- Best-fit role is `Tuttocampista` with model support score `54`.
- Primary archetype leans toward `Dribbler` behaviour from a `CM` base.
- Tactical fit is strongest when the game asks for High Press.
- Most bankable strengths show up in First Touch, Pass Range, and Aerial Duels.

## In Possession

- Ball-value indicators lean on First Touch, Pass Range, and Aerial Duels.
