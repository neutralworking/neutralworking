...
Lars Unnerstall projects primarily as a GK with a `GK` lean. The strongest database support comes from Physical, Reactions, and Close Range.

## Role Fit

- Primary archetype leans toward `GK` behaviour from a `GK` base.
- Most bankable strengths show up in Physical, Reactions, and Close Range.
- Profile should be judged on shot-stopping, area command, and distribution fit to team style.

## In Possession

- Ball-value indicators lean on Physical, Reactions, and Close Range.
