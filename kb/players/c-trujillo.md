...
C. Trujillo projects primarily as a CM with a `Destroyer` lean. The strongest database support comes from Aggression, Technical, and Blocking.
...
- Most bankable strengths show up in Aggression, Technical, and Blocking.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Aggression, Technical, and Blocking.
