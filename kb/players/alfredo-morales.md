...
category: players
tags: [CM, Cruz Azul, Powerhouse]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at Cruz Azul. Archetype: Powerhouse.
person_id: 8225
backlinks: [powerhouse, mezzala, cruz-azul]
---
...
Alfredo Morales projects primarily as a CM with a `Powerhouse` lean. The strongest database support comes from Aggression, Physical, and Balance.
...
- Most bankable strengths show up in Aggression, Physical, and Balance.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Aggression, Physical, and Balance.
