...
David Morales projects primarily as a CF with a `—` lean. The strongest database support comes from Through Balls, Vision, and Creativity.
...
- Best-fit role is [[falso-nove]] Falso Nove with model support score `40`.
