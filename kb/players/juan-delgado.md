...
Juan Delgado projects primarily as a CM with a `—` lean. The strongest database support comes from Discipline, Technical, and Close Range.
...
- Most bankable strengths show up in Discipline, Technical, and Close Range.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Discipline, Technical, and Close Range.
