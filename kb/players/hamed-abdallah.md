---
title: Hamed Abdallah
category: players
tags: [WM, ENPPI, Creator-Cover]
updated: 2026-04-18
source: compiled
confidence: high
summary: WM at ENPPI. Archetype: Creator-Cover.
person_id: 27718
backlinks: [creator, enppi]
---
...
Hamed Abdallah projects primarily as a WM with a `Creator-Cover` lean. The strongest database support comes from Composure, Duels, and Flair.
...
- Best-fit role is `False Winger` with model support score `58`.
- Primary archetype leans toward `Creator` behaviour from a `WM` base.
- Most bankable strengths show up in Composure, Duels, and Flair.

## In Possession

- Ball-value indicators lean on Composure, Duels, and Flair.
