---
title: Rafael Genuino
category: players
tags: [CF, Botafogo, Striker-Creator]
updated: 2026-04-19
source: compiled
confidence: high
summary: CF at Botafogo. Archetype: Striker-Creator.
person_id: 26623
backlinks: [striker, seconda-punta, botafogo]
---
...
Rafael Genuino projects primarily as a CF with a `Striker-Creator` lean. The strongest database support comes from Discipline, Close Range, and Concentration.
...
- Best-fit role is [[seconda-punta]] Seconda Punta with model support score `31`.
- Primary archetype leans toward `Striker` behaviour from a `CF` base.
- Most bankable strengths show up in Discipline, Close Range, and Concentration.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Discipline, Close Range, and Concentration.
