...
Kaku projects primarily as a CM with a `—` lean. The strongest database support comes from Close Range, Flair, and Crossing.
...
- Most bankable strengths show up in Close Range, Flair, and Crossing.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Close Range, Flair, and Crossing.
