...
Fang Jingqi projects primarily as a GK with a `Sprinter` lean. The strongest database support comes from Reactions, Stamina, and Acceleration.
...
- Most bankable strengths show up in Reactions, Stamina, and Acceleration.
- Profile should be judged on shot-stopping, area command, and distribution fit to team style.

## In Possession

- Ball-value indicators lean on Reactions, Stamina, and Acceleration.
