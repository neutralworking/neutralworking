...
Jonathan Torres projects primarily as a CF with a `—` lean. The strongest database support comes from Duels, Creativity, and Long Range.
...
- Best-fit role is [[target-forward]] Target Forward with model support score `51`.
- Most bankable strengths show up in Duels, Creativity, and Long Range.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Duels, Creativity, and Long Range.
