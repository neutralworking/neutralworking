...
title: K. Picón
category: players
tags: [CD, Santos Laguna, Cover]
updated: 2026-04-19
source: compiled
confidence: high
summary: CD at Santos Laguna. Archetype: Cover.
person_id: 26919
backlinks: [cover, stopper, santos-laguna]
---
...
K. Picón projects primarily as a CD with a `Cover` lean. The strongest database support comes from Aggression, Tackling, and Skills.
...
- Best-fit role is [[stopper]] Stopper with model support score `34`.
- Primary archetype leans toward `Cover` behaviour from a `CD` base.
- Most bankable strengths show up in Aggression, Tackling, and Skills.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Aggression, Tackling, and Skills.
