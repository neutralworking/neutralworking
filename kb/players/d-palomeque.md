...
person_id: 27588
backlinks: [destroyer, ball-winner, ad-union-magdalena]
---
...
D. Palomeque projects primarily as a CM with a `Destroyer` lean. The strongest database support comes from Intensity, Aggression, and Blocking.
...
- Most bankable strengths show up in Intensity, Aggression, and Blocking.

## In Possession

- Ball-value indicators lean on Intensity, Aggression, and Blocking.
