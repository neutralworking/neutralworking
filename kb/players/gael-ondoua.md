...
title: Gaël Ondoua
category: players
tags: [CM, Servette, Sprinter-Engine]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at Servette. Archetype: Sprinter-Engine.
person_id: 19781
backlinks: [sprinter, ball-winner, servette]
---
...
Gaël Ondoua projects primarily as a CM with a `Sprinter-Engine` lean. The strongest database support comes from Acceleration, Jumping, and Pass Accuracy.
...
- Most bankable strengths show up in Acceleration, Jumping, and Pass Accuracy.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Acceleration, Jumping, and Pass Accuracy.
