---
title: Gabriel Caipira
category: players
tags: [CM, Corinthians, Creator-Cover]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at Corinthians. Archetype: Creator-Cover.
person_id: 24603
backlinks: [creator, tuttocampista, corinthians]
---
...
Gabriel Caipira projects primarily as a CM with a `Creator-Cover` lean. The strongest database support comes from Take Ons, Interceptions, and Pressing.
...
- Best-fit role is [[tuttocampista]] Tuttocampista with model support score `37`.
- Primary archetype leans toward `Creator` behaviour from a `CM` base.
- Most bankable strengths show up in Take Ons, Interceptions, and Pressing.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Take Ons, Interceptions, and Pressing.
