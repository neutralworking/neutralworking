...
K. Keita projects primarily as a CM with a `Destroyer-Striker` lean. The strongest database support comes from Flair, Take Ons, and Blocking.
...
- Best-fit role is [[mezzala]] Mezzala with model support score `72`.
- Primary archetype leans toward `Destroyer` behaviour from a `CM` base.
- Most bankable strengths show up in Flair, Take Ons, and Blocking.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Flair, Take Ons, and Blocking.
