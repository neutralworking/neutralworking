...
J. Fedorco projects primarily as a CM with a `Destroyer` lean. The strongest database support comes from Blocking, Intensity, and Interceptions.
...
- Most bankable strengths show up in Blocking, Intensity, and Interceptions.

## In Possession

- Ball-value indicators lean on Blocking, Intensity, and Interceptions.
