---
title: Pierre Lees-Melou
category: players
tags: [CM, Brest, France, Engine-Passer]
updated: 2026-04-17
source: compiled
confidence: high
summary: CM at Brest. Archetype: Engine-Passer.
person_id: 16333
backlinks: [engine, brest]
---
...
Experienced midfielder serving squad rotation role; reliable in possession but noticeably slowed by age, limiting his effectiveness against high-intensity pressing.

## Role Fit

- Best-fit role is `Playmaker` with model support score `74`.
- Primary archetype leans toward `Engine` behaviour from a `CM` base.
- Most bankable strengths show up in Stamina, Composure, and Crossing.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Stamina, Composure, and Crossing.
- Style traits point toward Two Footed, Work Rate, and Long Range Passing in possession.
