...
Jonathan Benitez projects primarily as a CM with a `—` lean. The strongest database support comes from Aggression, Blocking, and Tackling.
...
- Best-fit role is [[ball-winner]] Ball Winner with model support score `48`.
