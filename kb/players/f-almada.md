...
person_id: 22404
backlinks: [destroyer, tuttocampista, mazatlan-fc]
---
...
F. Almada projects primarily as a CM with a `Destroyer-Striker` lean. The strongest database support comes from Stamina, Close Range, and Blocking.
...
- Most bankable strengths show up in Stamina, Close Range, and Blocking.

## In Possession

- Ball-value indicators lean on Stamina, Close Range, and Blocking.
