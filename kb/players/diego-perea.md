...
Diego Perea projects primarily as a CF with a `—` lean. The strongest database support comes from Communication, Concentration, and Leadership.
...
- Best-fit role is [[target-forward]] Target Forward with model support score `17`.
