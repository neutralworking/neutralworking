...
Diego Navarro projects primarily as a CM with a `—` lean. The strongest database support comes from Aggression, Flair, and Pass Accuracy.
...
- Best-fit role is [[playmaker]] Playmaker with model support score `43`.
