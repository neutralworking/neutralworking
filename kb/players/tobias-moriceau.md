...
Tobias Moriceau projects primarily as a CM with a `—` lean. The strongest database support comes from Blocking, Pass Accuracy, and Interceptions.
...
- Most bankable strengths show up in Blocking, Pass Accuracy, and Interceptions.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Blocking, Pass Accuracy, and Interceptions.
