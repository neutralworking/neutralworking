...
category: players
tags: [CM, Houston Dynamo FC, Cover]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at Houston Dynamo FC. Archetype: Cover.
person_id: 26732
...
Antônio Carlos projects primarily as a CM with a `Cover` lean. The strongest database support comes from Interceptions, Threat, and Awareness.
...
- Most bankable strengths show up in Interceptions, Threat, and Awareness.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Interceptions, Threat, and Awareness.
