...
Alberto Quintero projects primarily as a CM with a `None` lean. The strongest database support comes from Composure, Discipline, and Close Range.
...
- Best-fit role is `Metodista` with model support score `38`.
- Most bankable strengths show up in Composure, Discipline, and Close Range.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Composure, Discipline, and Close Range.
