...
Eliezer Barreto projects primarily as a CD with a `—` lean. The strongest database support comes from Pressing, Tackling, and Concentration.
...
- Most bankable strengths show up in Pressing, Tackling, and Concentration.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Pressing, Tackling, and Concentration.
