...
Sergio Bernardo Almirón projects primarily as a CM with a `Passer` lean. The strongest database support comes from Pass Accuracy, Pass Range, and Vision.
