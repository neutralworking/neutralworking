---
title: Milan Petržela
category: players
tags: [CM, Slovácko, Czechia, Striker-Creator]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at Slovácko. Archetype: Striker-Creator.
person_id: 15221
backlinks: [striker, playmaker, slovacko]
---
...
Milan Petržela projects primarily as a CM with a `Striker-Creator` lean. The strongest database support comes from Long Range, Close Range, and Creativity.
...
- Best-fit role is [[playmaker]] Playmaker with model support score `44`.
- Primary archetype leans toward `Striker` behaviour from a `CM` base.
- Most bankable strengths show up in Long Range, Close Range, and Creativity.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Long Range, Close Range, and Creativity.
