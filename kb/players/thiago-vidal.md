...
Thiago Vidal projects primarily as a CF with a `—` lean. The strongest database support comes from Pass Accuracy, Composure, and Discipline.
...
- Best-fit role is [[falso-nove]] Falso Nove with model support score `25`.
