...
Mohammed Ounajem projects primarily as a CF with a `—` lean. The strongest database support comes from Penalties, Close Range, and Creativity.
...
- Most bankable strengths show up in Penalties, Close Range, and Creativity.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Penalties, Close Range, and Creativity.
