...
J. Husebø projects primarily as a CM with a `Cover` lean. The strongest database support comes from Blocking, Interceptions, and Discipline.
...
- Most bankable strengths show up in Blocking, Interceptions, and Discipline.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Blocking, Interceptions, and Discipline.
