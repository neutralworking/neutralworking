...
person_id: 20963
backlinks: [striker, prima-punta, fk-crvena-zvezda]
---
...
C. Ndiaye projects primarily as a CF with a `Striker` lean. The strongest database support comes from Aggression, Close Range, and Duels.
