...
Gustavo Manzur projects primarily as a CM with a `—` lean. The strongest database support comes from Aggression, Blocking, and Close Range.
...
- Best-fit role is [[mezzala]] Mezzala with model support score `24`.
- Most bankable strengths show up in Aggression, Blocking, and Close Range.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Aggression, Blocking, and Close Range.
