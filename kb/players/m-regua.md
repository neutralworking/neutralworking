...
M. Reguła projects primarily as a WM with a `Striker-Creator` lean. The strongest database support comes from Aggression, Threat, and Close Range.
...
- Most bankable strengths show up in Aggression, Threat, and Close Range.

## In Possession

- Ball-value indicators lean on Aggression, Threat, and Close Range.
