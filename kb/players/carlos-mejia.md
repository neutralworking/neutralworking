...
title: Carlos Mejía
category: players
tags: [CM, UTC, Honduras]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at UTC. Archetype: —.
person_id: 28520
...
Carlos Mejía projects primarily as a CM with a `—` lean. The strongest database support comes from Threat, Close Range, and Leadership.
...
- Most bankable strengths show up in Threat, Close Range, and Leadership.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Threat, Close Range, and Leadership.
