...
A. Erlingmark projects primarily as a CM with a `Destroyer-Powerhouse` lean. The strongest database support comes from Physical, Stamina, and Heading.
...
- Most bankable strengths show up in Physical, Stamina, and Heading.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Physical, Stamina, and Heading.
