...
person_id: 24881
backlinks: [striker, wide-target-forward, sturm-graz]
---
...
L. Grgić projects primarily as a WF with a `Striker-Creator` lean. The strongest database support comes from Pass Accuracy, Aggression, and Penalties.
...
- Most bankable strengths show up in Pass Accuracy, Aggression, and Penalties.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Pass Accuracy, Aggression, and Penalties.
