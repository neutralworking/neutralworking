...
title: M. Ćosić
category: players
tags: [CM, Radnički 1923 Kragujevac, Creator-Cover]
updated: 2026-04-17
source: compiled
confidence: high
summary: CM at Radnički 1923 Kragujevac. Archetype: Creator-Cover.
person_id: 23915
...
M. Ćosić projects primarily as a CM with a `Creator-Cover` lean. The strongest database support comes from Creativity, Discipline, and Interceptions.

## Role Fit

- Best-fit role is `Playmaker` with model support score `72`.
- Primary archetype leans toward `Creator` behaviour from a `CM` base.
- Most bankable strengths show up in Creativity, Discipline, and Interceptions.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Creativity, Discipline, and Interceptions.
