...
A. PetroviÄ projects primarily as a AM with a `Creator-Striker` lean. The strongest database support comes from Discipline, Communication, and Composure.
...
- Best-fit role is `Mediapunta` with model support score `33`.
