...
Gustavo Mendoza projects primarily as a CF with a `—` lean. The strongest database support comes from Pressing, Pass Accuracy, and Through Balls.
...
- Best-fit role is [[falso-nove]] Falso Nove with model support score `50`.
- Most bankable strengths show up in Pressing, Pass Accuracy, and Through Balls.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Pressing, Pass Accuracy, and Through Balls.
