...
Brian Blasi projects primarily as a CD with a `—` lean. The strongest database support comes from Marking, Pressing, and Aggression.
...
- Most bankable strengths show up in Marking, Pressing, and Aggression.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Marking, Pressing, and Aggression.
