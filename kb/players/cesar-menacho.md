...
Cesar Menacho projects primarily as a CF with a `—` lean. The strongest database support comes from Discipline, Long Range, and Concentration.
...
- Best-fit role is [[seconda-punta]] Seconda Punta with model support score `32`.
- Most bankable strengths show up in Discipline, Long Range, and Concentration.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Discipline, Long Range, and Concentration.
