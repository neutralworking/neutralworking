...
M. Niegbo projects primarily as a CD with a `None` lean. The strongest database support comes from Composure, Discipline, and Concentration.

## Role Fit

- Best-fit role is `Sweeper`.
- Most bankable strengths show up in Composure, Discipline, and Concentration.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Composure, Discipline, and Concentration.
