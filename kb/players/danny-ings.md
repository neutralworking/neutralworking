...
person_id: 9993
backlinks: [striker, prima-punta, sheffield-united]
---
...
Still-sharp, intelligent striker with excellent positioning and movement in the box; experience and professionalism valuable, but pace decline and injury history mean he's best suited as a backup or for teams playing slower, possession-based football.
...
- Best-fit role is [[prima-punta]] Prima Punta with model support score `64`.
- Primary archetype leans toward `Striker` behaviour from a `CF` base.
- Most bankable strengths show up in Movement, Reactions, and Aerial Duels.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Movement, Reactions, and Aerial Duels.
- Style traits point toward Acrobatic in possession.
