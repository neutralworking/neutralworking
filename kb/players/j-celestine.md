...
person_id: 26739
backlinks: [destroyer, playmaker, mzks-arka-gdynia]
---
...
J. Célestine projects primarily as a CM with a `Destroyer-Striker` lean. The strongest database support comes from Blocking, Pass Accuracy, and Technical.
...
- Most bankable strengths show up in Blocking, Pass Accuracy, and Technical.

## In Possession

- Ball-value indicators lean on Blocking, Pass Accuracy, and Technical.
