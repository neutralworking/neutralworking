...
Michael Esser projects primarily as a GK with a `GK` lean. The strongest database support comes from Close Range, Pace, and Pass Range.

## Role Fit

- Best-fit role is `Sweeper Keeper`.
- Primary archetype leans toward `GK` behaviour from a `GK` base.
- Most bankable strengths show up in Close Range, Pace, and Pass Range.
- Profile should be judged on shot-stopping, area command, and distribution fit to team style.

## In Possession

- Ball-value indicators lean on Close Range, Pace, and Pass Range.
