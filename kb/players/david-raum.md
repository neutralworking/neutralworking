...
title: David Raum
category: players
tags: [WD, RB Leipzig, Germany, Creator-Dribbler]
updated: 2026-04-19
source: compiled
confidence: high
summary: WD at RB Leipzig. Archetype: Creator-Dribbler.
person_id: 10111
backlinks: [creator, fullback, rb-leipzig]
---
...
Attack-minded left-back who uses pace and stamina to dominate the flank; defensive positioning can be reckless, and his reliance on athleticism makes him vulnerable against technical wingers in transition.
...
- Best-fit role is [[fullback]] Fullback with model support score `82`.
- Primary archetype leans toward `Creator` behaviour from a `WD` base.
- Most bankable strengths show up in First Touch, Jumping, and Take Ons.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on First Touch, Jumping, and Take Ons.
- Style traits point toward Set Piece Threat, Pace, and Trivela in possession.
