...
A. Petkov projects primarily as a CM with a `Destroyer` lean. The strongest database support comes from Blocking, Pass Accuracy, and Duels.
...
- Most bankable strengths show up in Blocking, Pass Accuracy, and Duels.

## In Possession

- Ball-value indicators lean on Blocking, Pass Accuracy, and Duels.
