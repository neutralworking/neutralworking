...
Alejandro Silva projects primarily as a CM with a `—` lean. The strongest database support comes from Discipline, Crossing, and Composure.
...
- Most bankable strengths show up in Discipline, Crossing, and Composure.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Discipline, Crossing, and Composure.
