...
person_id: 26638
backlinks: [destroyer, ball-winner, randers-fc]
---
...
L. Lissens projects primarily as a CM with a `Destroyer-Powerhouse` lean. The strongest database support comes from Aggression, Balance, and Jumping.
...
- Most bankable strengths show up in Aggression, Balance, and Jumping.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Aggression, Balance, and Jumping.
