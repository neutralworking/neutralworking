...
D. Đoković projects primarily as a CM with a `Striker-Cover` lean. The strongest database support comes from Close Range, Long Range, and Aggression.
...
- Most bankable strengths show up in Close Range, Long Range, and Aggression.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Close Range, Long Range, and Aggression.
