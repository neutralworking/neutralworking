...
Ivan Maggi projects primarily as a CF with a `—` lean. The strongest database support comes from Close Range, Long Range, and Mid Range.
...
- Best-fit role is [[prima-punta]] Prima Punta with model support score `60`.
