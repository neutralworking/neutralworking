...
person_id: 21674
backlinks: [destroyer, metodista, estrela-da-amadora]
---
...
A. Chernev projects primarily as a CM with a `Destroyer` lean. The strongest database support comes from Duels, Blocking, and Mid Range.
...
- Most bankable strengths show up in Duels, Blocking, and Mid Range.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Duels, Blocking, and Mid Range.
