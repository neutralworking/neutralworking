...
Felipe Mejia projects primarily as a CF with a `—` lean. The strongest database support comes from Composure, Close Range, and Long Range.
...
- Best-fit role is `Prima Punta` with model support score `59`.
- Most bankable strengths show up in Composure, Close Range, and Long Range.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Composure, Close Range, and Long Range.
