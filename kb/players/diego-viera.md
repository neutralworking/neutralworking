...
Diego Viera projects primarily as a CD with a `None` lean. The strongest database support comes from Aerial Duels, Heading, and Skills.

## Role Fit

- Best-fit role is `Colossus` with model support score `45`.
