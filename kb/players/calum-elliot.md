...
title: Calum Elliot
category: players
tags: [CM, Sprinter-Dribbler]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at —. Archetype: Sprinter-Dribbler.
person_id: 996
backlinks: [sprinter, ball-winner]
---
...
Calum Elliot projects primarily as a CM with a `Sprinter-Dribbler` lean. The strongest database support comes from Acceleration, First Touch, and Heading.
...
- Best-fit role is [[ball-winner]] Ball Winner with model support score `62`.
- Primary archetype leans toward `Sprinter` behaviour from a `CM` base.
- Tactical fit is strongest when the game asks for High Press.
- Most bankable strengths show up in Acceleration, First Touch, and Heading.

## In Possession

- Ball-value indicators lean on Acceleration, First Touch, and Heading.
