...
title: Cícero
category: players
tags: [CM, Tondela, Target]
updated: 2026-04-18
source: compiled
confidence: high
summary: CM at Tondela. Archetype: Target.
person_id: 1311
backlinks: [target, tondela]
---
...
Cícero projects primarily as a CM with a `Target` lean. The strongest database support comes from Heading, Pass Range, and Volleys.
...
- Most bankable strengths show up in Heading, Pass Range, and Volleys.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Heading, Pass Range, and Volleys.
