...
A. Ivanov projects primarily as a CM with a `Cover` lean. The strongest database support comes from Take Ons, Flair, and Long Range.
...
- Most bankable strengths show up in Take Ons, Flair, and Long Range.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Take Ons, Flair, and Long Range.
