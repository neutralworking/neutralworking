...
João Paulo Ananias projects primarily as a CM with a `Cover` lean. The strongest database support comes from Discipline, Interceptions, and Blocking.
...
- Most bankable strengths show up in Discipline, Interceptions, and Blocking.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Discipline, Interceptions, and Blocking.
