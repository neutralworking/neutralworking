...
Rhuan Gabriel projects primarily as a CF with a `Striker-Creator` lean. The strongest database support comes from Carries, Discipline, and Take Ons.

## Role Fit

- Best-fit role is `Shadow Striker` with model support score `47`.
- Primary archetype leans toward `Striker` behaviour from a `CF` base.
- Most bankable strengths show up in Carries, Discipline, and Take Ons.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Carries, Discipline, and Take Ons.
