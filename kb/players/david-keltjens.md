---
title: David Keltjens
category: players
tags: [CD, Hapoel Be'er Sheva, Israel, Powerhouse]
updated: 2026-04-17
source: compiled
confidence: high
summary: CD at Hapoel Be'er Sheva. Archetype: Powerhouse.
person_id: 10089
backlinks: [powerhouse, hapoel-beer-sheva]
---
...
David Keltjens projects primarily as a CD with a `Powerhouse` lean. The strongest database support comes from Composure, Acceleration, and Aggression.

## Role Fit

- Best-fit role is `Centrale`.
- Primary archetype leans toward `Powerhouse` behaviour from a `CD` base.
- Most bankable strengths show up in Composure, Acceleration, and Aggression.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Composure, Acceleration, and Aggression.
