...
title: F. Ihler
category: players
tags: [CF, IF Elfsborg, Sprinter-Dribbler]
updated: 2026-04-19
source: compiled
confidence: high
summary: CF at IF Elfsborg. Archetype: Sprinter-Dribbler.
person_id: 22370
backlinks: [sprinter, shadow-striker, if-elfsborg]
---
...
F. Ihler projects primarily as a CF with a `Sprinter-Dribbler` lean. The strongest database support comes from Pace, Shielding, and Jumping.
...
- Most bankable strengths show up in Pace, Shielding, and Jumping.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Pace, Shielding, and Jumping.
