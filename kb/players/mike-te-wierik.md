...
category: players
tags: [CM, Heracles, Cover]
updated: 2026-04-17
source: compiled
confidence: high
summary: CM at Heracles. Archetype: Cover.
person_id: 5180
backlinks: [cover, heracles]
---
...
Mike te Wierik projects primarily as a CM with a `Cover` lean. The strongest database support comes from Aerial Duels, Marking, and First Touch.

## Role Fit

- Best-fit role is `Tuttocampista` with model support score `72`.
- Primary archetype leans toward `Cover` behaviour from a `CM` base.
- Most bankable strengths show up in Aerial Duels, Marking, and First Touch.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Aerial Duels, Marking, and First Touch.
