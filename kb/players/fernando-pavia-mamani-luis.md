---
title: Fernando Pavia Mamani Luis
category: players
tags: [CM, Bolivia]
updated: 2026-04-19
source: compiled
...
Fernando Pavia Mamani Luis projects primarily as a CM with a `—` lean. The strongest database support comes from Pass Accuracy, Composure, and Close Range.
...
- Most bankable strengths show up in Pass Accuracy, Composure, and Close Range.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Pass Accuracy, Composure, and Close Range.
