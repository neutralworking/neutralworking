...
person_id: 30441
backlinks: [centrale, nacional-asuncion]
---
...
Axel Canete projects primarily as a CD with a `—` lean. The strongest database support comes from Skills, Concentration, and Drive.
...
- Best-fit role is [[centrale]] Centrale with model support score `49`.
