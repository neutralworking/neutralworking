...
Jose Diaz projects primarily as a CM with a `—` lean. The strongest database support comes from Blocking, Flair, and Take Ons.
...
- Best-fit role is [[mezzala]] Mezzala with model support score `45`.
- Most bankable strengths show up in Blocking, Flair, and Take Ons.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Blocking, Flair, and Take Ons.
