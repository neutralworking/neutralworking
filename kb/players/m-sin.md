...
M. Šín projects primarily as a CM with a `Cover-Creator` lean. The strongest database support comes from Close Range, Vision, and Long Range.
...
- Most bankable strengths show up in Close Range, Vision, and Long Range.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Close Range, Vision, and Long Range.
