...
Sanchez Jhon projects primarily as a CF with a `—` lean. The strongest database support comes from Pressing, Skills, and Through Balls.
...
- Best-fit role is [[target-forward]] Target Forward with model support score `29`.
- Most bankable strengths show up in Pressing, Skills, and Through Balls.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Pressing, Skills, and Through Balls.
