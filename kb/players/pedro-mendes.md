...
person_id: 16237
backlinks: [sprinter, target-forward, estrela-da-amadora]
---
...
Pedro Mendes projects primarily as a CF with a `Sprinter` lean. The strongest database support comes from Balance, Jumping, and Close Range.
...
- Most bankable strengths show up in Balance, Jumping, and Close Range.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Balance, Jumping, and Close Range.
