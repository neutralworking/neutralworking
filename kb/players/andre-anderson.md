...
category: players
tags: [CM, Lazio, Italy, Dribbler-Sprinter]
updated: 2026-04-17
source: compiled
confidence: high
summary: CM at Lazio. Archetype: Dribbler-Sprinter.
person_id: 8412
backlinks: [dribbler, lazio]
---
...
Italian-based midfielder at 26 with reasonable technical security and passing range through the centre. Lacks the positional discipline or press resistance for a more demanding environment; gets turned too easily in transition and doesn't contribute enough defensively to justify selection at a bigger club. Serviceable Eredivisie regular.

## Role Fit

- Primary archetype leans toward `Dribbler` behaviour from a `CM` base.
- Most bankable strengths show up in Balance, Take Ons, and Acceleration.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Balance, Take Ons, and Acceleration.
