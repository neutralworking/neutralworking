...
Pinto Jose projects primarily as a CM with a `—` lean. The strongest database support comes from Interceptions, Blocking, and Pass Accuracy.
...
- Most bankable strengths show up in Interceptions, Blocking, and Pass Accuracy.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Interceptions, Blocking, and Pass Accuracy.
