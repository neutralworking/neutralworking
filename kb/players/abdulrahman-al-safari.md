...
Abdulrahman Al Safari projects primarily as a CM with a `Destroyer-Creator` lean. The strongest database support comes from Blocking, Interceptions, and Technical.
...
- Most bankable strengths show up in Blocking, Interceptions, and Technical.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Blocking, Interceptions, and Technical.
