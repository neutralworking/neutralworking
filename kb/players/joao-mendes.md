...
title: João Mendes
category: players
tags: [CM, Vitória Guimarães, Portugal, Dribbler]
updated: 2026-04-18
source: compiled
confidence: high
summary: CM at Vitória Guimarães. Archetype: Dribbler.
person_id: 12678
...
João Mendes projects primarily as a CM with a `Dribbler` lean. The strongest database support comes from Movement, Pass Range, and Physical.
...
- Most bankable strengths show up in Movement, Pass Range, and Physical.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Movement, Pass Range, and Physical.
