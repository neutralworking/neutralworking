...
person_id: 25522
backlinks: [destroyer, metodista, brommapojkarna]
---
...
H. Karlsson projects primarily as a CM with a `Destroyer-Powerhouse` lean. The strongest database support comes from Shielding, Stamina, and Heading.
...
- Most bankable strengths show up in Shielding, Stamina, and Heading.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Shielding, Stamina, and Heading.
