...
C. Morris projects primarily as a CF with a `Striker` lean. The strongest database support comes from Duels, Close Range, and Penalties.
...
- Most bankable strengths show up in Duels, Close Range, and Penalties.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Duels, Close Range, and Penalties.
