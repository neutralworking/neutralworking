...
Lucas Montiel projects primarily as a CM with a `—` lean. The strongest database support comes from Aggression, Creativity, and Duels.
...
- Best-fit role is [[mezzala]] Mezzala with model support score `44`.
