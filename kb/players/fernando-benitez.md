...
Fernando Benitez projects primarily as a CM with a `—` lean. The strongest database support comes from Aggression, Interceptions, and Take Ons.
...
- Best-fit role is [[tuttocampista]] Tuttocampista with model support score `32`.
- Most bankable strengths show up in Aggression, Interceptions, and Take Ons.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Aggression, Interceptions, and Take Ons.
