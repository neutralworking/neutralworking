...
G. Pérez projects primarily as a CM with a `Destroyer-Target` lean. The strongest database support comes from Heading, Marking, and Pass Range.
...
- Most bankable strengths show up in Heading, Marking, and Pass Range.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Heading, Marking, and Pass Range.
