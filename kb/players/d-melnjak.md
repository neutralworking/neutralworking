...
title: D. Melnjak
category: players
tags: [CM, HNK Hajduk Split, Cover-Sprinter]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at HNK Hajduk Split. Archetype: Cover-Sprinter.
person_id: 25663
backlinks: [cover, playmaker, hnk-hajduk-split]
---
...
D. Melnjak projects primarily as a CM with a `Cover-Sprinter` lean. The strongest database support comes from Movement, Stamina, and Acceleration.
...
- Best-fit role is [[playmaker]] Playmaker with model support score `54`.
- Primary archetype leans toward `Cover` behaviour from a `CM` base.
- Most bankable strengths show up in Movement, Stamina, and Acceleration.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Movement, Stamina, and Acceleration.
