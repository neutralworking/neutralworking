...
Daniel Majstorović projects primarily as a CD with a `Destroyer` lean. The strongest database support comes from Interceptions, Marking, and Tackling.
