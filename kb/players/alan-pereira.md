...
Alan Pereira projects primarily as a CF with a `None` lean. The strongest database support comes from Discipline, Communication, and Concentration.
...
- Best-fit role is `Falso Nove` with model support score `23`.
