...
title: A. Pejović
category: players
tags: [AM, FK Radnik Surdulica, Creator]
updated: 2026-04-19
source: compiled
confidence: high
summary: AM at FK Radnik Surdulica. Archetype: Creator.
person_id: 23009
backlinks: [creator, incursore, fk-radnik-surdulica]
---
...
A. Pejović projects primarily as a AM with a `Creator` lean. The strongest database support comes from Aggression, Pressing, and Through Balls.
...
- Best-fit role is [[incursore]] Incursore with model support score `71`.
- Primary archetype leans toward `Creator` behaviour from a `AM` base.
- Most bankable strengths show up in Aggression, Pressing, and Through Balls.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Aggression, Pressing, and Through Balls.
