...
Damian Batallini projects primarily as a CM with a `—` lean. The strongest database support comes from Duels, Mid Range, and Pace.
...
- Most bankable strengths show up in Duels, Mid Range, and Pace.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Duels, Mid Range, and Pace.
