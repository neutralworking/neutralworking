...
person_id: 28596
backlinks: [falso-nove, orlando-pirates]
---
...
Tshepang Moremi projects primarily as a CF with a `—` lean. The strongest database support comes from Communication, Concentration, and Creativity.
...
- Best-fit role is [[falso-nove]] Falso Nove with model support score `30`.
