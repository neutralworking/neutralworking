---
title: Kjell Peersman
category: players
tags: [GK, KAA Gent, Belgium, Powerhouse-Destroyer]
updated: 2026-04-17
source: compiled
confidence: high
summary: GK at KAA Gent. Archetype: Powerhouse-Destroyer.
person_id: 13576
backlinks: [powerhouse, kaa-gent]
---
...
Kjell Peersman projects primarily as a GK with a `Powerhouse-Destroyer` lean. The strongest database support comes from Aggression, Pace, and Physical.

## Role Fit

- Primary archetype leans toward `Powerhouse` behaviour from a `GK` base.
- Most bankable strengths show up in Aggression, Pace, and Physical.
- Profile should be judged on shot-stopping, area command, and distribution fit to team style.

## In Possession

- Ball-value indicators lean on Aggression, Pace, and Physical.
