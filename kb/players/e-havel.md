...
title: E. Havel
category: players
tags: [CF, LASK Linz, Striker]
updated: 2026-04-17
source: compiled
confidence: high
summary: CF at LASK Linz. Archetype: Striker.
person_id: 26848
backlinks: [striker, lask-linz]
---
...
E. Havel projects primarily as a CF with a `Striker` lean. The strongest database support comes from Mid Range, Pass Accuracy, and Penalties.

## Role Fit

- Best-fit role is `Prima Punta` with model support score `71`.
- Primary archetype leans toward `Striker` behaviour from a `CF` base.
- Most bankable strengths show up in Mid Range, Pass Accuracy, and Penalties.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Mid Range, Pass Accuracy, and Penalties.
