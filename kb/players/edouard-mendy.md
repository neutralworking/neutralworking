...
Senegalese goalkeeper now in his mid-thirties but still demonstrating the shot-stopping authority and distribution composure that made him a top European performer. His reactions remain sharp and his command of the box is authoritative, though the pace of his decline should be monitored closely. He's a reliable custodian for a transitional phase but not a long-term solution for an ambitious club.

## Role Fit

- Best-fit role is `Comandante`.
- Primary archetype leans toward `GK` behaviour from a `GK` base.
- Most bankable strengths show up in Reactions, Jumping, and Communication.
- Profile should be judged on shot-stopping, area command, and distribution fit to team style.

## In Possession

- Ball-value indicators lean on Reactions, Jumping, and Communication.
...
| Anticipation | ███████░░░ 7/10 | One of the stronger current indicators for this profile at 7/10. |
