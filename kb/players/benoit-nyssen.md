...
Benoît Nyssen projects primarily as a CM with a `Cover` lean. The strongest database support comes from Close Range, Mid Range, and Awareness.
...
- Most bankable strengths show up in Close Range, Mid Range, and Awareness.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Close Range, Mid Range, and Awareness.
