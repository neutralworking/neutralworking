---
title: Daniel Bentaberry Varela Bryan
category: players
tags: [CD, Paraguay]
updated: 2026-04-17
source: compiled
...
# Daniel Bentaberry Varela Bryan
...
Daniel Bentaberry Varela Bryan projects primarily as a CD with a `None` lean. The strongest database support comes from Discipline, Blocking, and Drive.

## Role Fit

- Best-fit role is `Centrale`.
- Most bankable strengths show up in Discipline, Blocking, and Drive.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Discipline, Blocking, and Drive.
