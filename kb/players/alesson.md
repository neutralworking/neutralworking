...
Alesson projects primarily as a WF with a `Creator-Striker` lean. The strongest database support comes from Aggression, Close Range, and Composure.
...
- Ball-value indicators lean on Aggression, Close Range, and Composure.
