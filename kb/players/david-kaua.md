...
David Kauã projects primarily as a CF with a `Striker` lean. The strongest database support comes from Aggression, Skills, and Drive.
...
- Most bankable strengths show up in Aggression, Skills, and Drive.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Aggression, Skills, and Drive.
