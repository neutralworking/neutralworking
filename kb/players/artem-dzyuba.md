...
title: Artem Dzyuba
category: players
tags: [CF, Russia, Striker-Creator]
updated: 2026-04-19
source: compiled
confidence: high
...
Artem Dzyuba projects primarily as a CF with a `Striker-Creator` lean. The strongest database support comes from Acceleration, Long Range, and Mid Range.
...
- Best-fit role is [[spearhead]] Spearhead with model support score `53`.
