...
R. Lauritsen projects primarily as a CM with a `Destroyer-Striker` lean. The strongest database support comes from Blocking, Pass Accuracy, and Positioning.
...
- Most bankable strengths show up in Blocking, Pass Accuracy, and Positioning.

## In Possession

- Ball-value indicators lean on Blocking, Pass Accuracy, and Positioning.
