...
title: Erik Janža
category: players
tags: [WD, Górnik Zabrze, Slovenia, Powerhouse]
updated: 2026-04-19
source: compiled
confidence: high
summary: WD at Górnik Zabrze. Archetype: Powerhouse.
person_id: 10759
backlinks: [powerhouse, wing-back, gornik-zabrze]
---
...
Erik Janža projects primarily as a WD with a `Powerhouse` lean. The strongest database support comes from Shielding, Crossing, and Through Balls.
...
- Best-fit role is [[wing-back]] Wing-back with model support score `71`.
- Primary archetype leans toward `Powerhouse` behaviour from a `WD` base.
- Most bankable strengths show up in Shielding, Crossing, and Through Balls.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Shielding, Crossing, and Through Balls.
