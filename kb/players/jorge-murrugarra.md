...
person_id: 28077
backlinks: [tuttocampista, universitario]
---
...
Jorge Murrugarra projects primarily as a CM with a `—` lean. The strongest database support comes from Aggression, Awareness, and Communication.
...
- Best-fit role is [[tuttocampista]] Tuttocampista with model support score `20`.
