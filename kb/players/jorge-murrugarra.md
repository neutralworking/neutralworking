...
Jorge Murrugarra projects primarily as a CM with a `None` lean. The strongest database support comes from Aggression, Awareness, and Communication.

## Role Fit

- Best-fit role is `Tuttocampista` with model support score `20`.
