...
Emanuel Paniagua projects primarily as a CF with a `—` lean. The strongest database support comes from Duels, Pass Accuracy, and Take Ons.
...
- Best-fit role is [[target-forward]] Target Forward with model support score `64`.
