...
person_id: 23442
backlinks: [striker, prima-punta, wsg-wattens]
---
...
V. Müller projects primarily as a CF with a `Striker-Creator` lean. The strongest database support comes from Pass Accuracy, Aerial Duels, and Close Range.
...
- Most bankable strengths show up in Pass Accuracy, Aerial Duels, and Close Range.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Pass Accuracy, Aerial Duels, and Close Range.
