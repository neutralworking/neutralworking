...
G. Benavídez projects primarily as a CM with a `Striker-Creator` lean. The strongest database support comes from Discipline, Close Range, and Threat.
...
- Most bankable strengths show up in Discipline, Close Range, and Threat.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Discipline, Close Range, and Threat.
