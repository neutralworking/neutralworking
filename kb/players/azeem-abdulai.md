...
title: Azeem Abdulai
category: players
tags: [CM, Swansea City, Scotland, Dribbler]
updated: 2026-04-18
source: compiled
confidence: high
summary: CM at Swansea City. Archetype: Dribbler.
person_id: 8835
backlinks: [dribbler, swansea-city]
---
...
Box-to-box midfielder with energy and work ethic but limited technical ability and game intelligence; makes simple errors in possession. A rotational option for lower-table Championship sides, nothing aspirational.

## Role Fit

- Primary archetype leans toward `Dribbler` behaviour from a `CM` base.
- Most bankable strengths show up in Acceleration, Aggression, and Awareness.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Acceleration, Aggression, and Awareness.
