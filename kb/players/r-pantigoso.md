...
R. Pantigoso projects primarily as a CM with a `—` lean. The strongest database support comes from Discipline, Composure, and Communication.
...
- Best-fit role is [[metodista]] Metodista with model support score `30`.
