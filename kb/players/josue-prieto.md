...
Josue Prieto projects primarily as a CD with a `None` lean. The strongest database support comes from Blocking, Skills, and Pass Accuracy.

## Role Fit

- Best-fit role is `Centrale`.
- Most bankable strengths show up in Blocking, Skills, and Pass Accuracy.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Blocking, Skills, and Pass Accuracy.
