...
title: Eder González
category: players
tags: [CM, Asteras Tripolis, Cover-Creator]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at Asteras Tripolis. Archetype: Cover-Creator.
person_id: 25068
...
Eder González projects primarily as a CM with a `Cover-Creator` lean. The strongest database support comes from Awareness, Close Range, and Interceptions.
...
- Most bankable strengths show up in Awareness, Close Range, and Interceptions.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Awareness, Close Range, and Interceptions.
