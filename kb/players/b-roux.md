...
B. Roux projects primarily as a CM with a `Cover` lean. The strongest database support comes from Interceptions, Pass Accuracy, and Aggression.
...
- Most bankable strengths show up in Interceptions, Pass Accuracy, and Aggression.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Interceptions, Pass Accuracy, and Aggression.
