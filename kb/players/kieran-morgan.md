...
person_id: 20753
backlinks: [cover, queens-park-rangers]
---
...
Kieran Morgan projects primarily as a CM with a `Cover-Striker` lean. The strongest database support comes from Close Range, Interceptions, and Vision.
...
- Most bankable strengths show up in Close Range, Interceptions, and Vision.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Close Range, Interceptions, and Vision.
