...
V. Drchal projects primarily as a WM with a `Striker-Creator` lean. The strongest database support comes from Mid Range, Threat, and Aggression.
...
- Most bankable strengths show up in Mid Range, Threat, and Aggression.

## In Possession

- Ball-value indicators lean on Mid Range, Threat, and Aggression.
