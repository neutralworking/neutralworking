...
J. Jones projects primarily as a CM with a `Cover` lean. The strongest database support comes from Discipline, Composure, and Communication.
...
- Best-fit role is [[metodista]] Metodista with model support score `21`.
