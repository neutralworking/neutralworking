...
title: M. Gašić
category: players
tags: [CM, FK Radnik Surdulica, Creator-Destroyer]
updated: 2026-04-17
source: compiled
confidence: high
summary: CM at FK Radnik Surdulica. Archetype: Creator-Destroyer.
person_id: 22566
backlinks: [creator, fk-radnik-surdulica]
---
...
M. Gašić projects primarily as a CM with a `Creator-Destroyer` lean. The strongest database support comes from Creativity, Vision, and Through Balls.

## Role Fit

- Best-fit role is `Playmaker` with model support score `71`.
- Primary archetype leans toward `Creator` behaviour from a `CM` base.
- Most bankable strengths show up in Creativity, Vision, and Through Balls.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Creativity, Vision, and Through Balls.
