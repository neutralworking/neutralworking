...
title: Josué
category: players
tags: [CM, Legia Warszawa, Sprinter]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at Legia Warszawa. Archetype: Sprinter.
person_id: 3647
backlinks: [sprinter, metodista, legia-warszawa]
---
...
Josué projects primarily as a CM with a `Sprinter` lean. The strongest database support comes from Jumping, Shielding, and Aggression.
...
- Most bankable strengths show up in Jumping, Shielding, and Aggression.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Jumping, Shielding, and Aggression.
