...
Pedro Azogue projects primarily as a CM with a `—` lean. The strongest database support comes from Interceptions, Long Range, and Pass Accuracy.
...
- Most bankable strengths show up in Interceptions, Long Range, and Pass Accuracy.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Interceptions, Long Range, and Pass Accuracy.
