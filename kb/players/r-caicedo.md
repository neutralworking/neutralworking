...
source: compiled
confidence: low
summary: GK at Emelec. Archetype: GK.
person_id: 26224
backlinks: [gk, emelec]
---
...
R. Caicedo projects primarily as a GK with a `GK` lean. The strongest database support comes from the current evidence set.
