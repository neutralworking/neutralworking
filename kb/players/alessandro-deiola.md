...
category: players
tags: [CM, Cagliari, Italy, Destroyer-Target]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at Cagliari. Archetype: Destroyer-Target.
person_id: 8084
backlinks: [destroyer, tuttocampista, cagliari]
---
...
A functional box-to-box midfielder who does the unglamorous work of covering ground and breaking up play without much distinction. He's neither creative enough to start transitions nor defensively imposing enough to be a lynchpin, which makes him useful depth in a settled side but unremarkable when called upon. His passing is safe rather than progressive, and he doesn't drive the ball forward with intent.
...
- Best-fit role is [[tuttocampista]] Tuttocampista with model support score `58`.
- Primary archetype leans toward `Destroyer` behaviour from a `CM` base.
- Tactical fit is strongest when the game asks for High Press.
- Most bankable strengths show up in Physical, Jumping, and Movement.

## In Possession

- Ball-value indicators lean on Physical, Jumping, and Movement.
- Style traits point toward Strength, Defensive Awareness, and Aerial Ability in possession.
