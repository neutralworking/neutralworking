...
Diego Hoyos projects primarily as a CF with a `—` lean. The strongest database support comes from Aggression, Close Range, and Flair.
...
- Best-fit role is [[seconda-punta]] Seconda Punta with model support score `55`.
...
- Style traits point toward Cross Claimer, Footwork, and Long Range Passing in possession.
