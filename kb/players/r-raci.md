...
person_id: 25503
backlinks: [destroyer, tuttocampista, hnk-hajduk-split]
---
...
R. Raci projects primarily as a CM with a `Destroyer` lean. The strongest database support comes from Pass Accuracy, Tackling, and Aggression.
