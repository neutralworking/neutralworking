...
Albano Alessandrini projects primarily as a CD with a `None` lean. The strongest database support comes from Tackling, Creativity, and Drive.

## Role Fit

- Best-fit role is `Centrale`.
- Most bankable strengths show up in Tackling, Creativity, and Drive.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Tackling, Creativity, and Drive.
