...
person_id: 24345
backlinks: [destroyer, playmaker, panetolikos]
---
...
C. Sielis projects primarily as a CM with a `Destroyer-Creator` lean. The strongest database support comes from Blocking, Pass Accuracy, and Flair.
...
- Most bankable strengths show up in Blocking, Pass Accuracy, and Flair.

## In Possession

- Ball-value indicators lean on Blocking, Pass Accuracy, and Flair.
