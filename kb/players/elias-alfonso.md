...
Elias Alfonso projects primarily as a CM with a `—` lean. The strongest database support comes from Flair, Take Ons, and Creativity.
...
- Best-fit role is `Mezzala` with model support score `40`.
