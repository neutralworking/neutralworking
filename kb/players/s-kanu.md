...
person_id: 23021
backlinks: [creator, wide-playmaker, fc-fastav-zlin]
---
...
S. Kanu projects primarily as a WF with a `Creator-Striker` lean. The strongest database support comes from Close Range, Aggression, and Long Range.
...
- Most bankable strengths show up in Close Range, Aggression, and Long Range.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Close Range, Aggression, and Long Range.
