...
Alan Terrazas projects primarily as a CF with a `—` lean. The strongest database support comes from Pass Accuracy, Creativity, and Flair.
...
- Best-fit role is `Falso Nove` with model support score `71`.
