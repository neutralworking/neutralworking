---
title: Mitchell Thomas Duke
category: players
tags: [CF, Macarthur FC, Creator-Powerhouse]
updated: 2026-04-19
source: compiled
confidence: high
summary: CF at Macarthur FC. Archetype: Creator-Powerhouse.
person_id: 19864
backlinks: [creator, target-forward, macarthur-fc]
---
...
Mitchell Thomas Duke projects primarily as a CF with a `Creator-Powerhouse` lean. The strongest database support comes from Blocking, Aerial Duels, and Aggression.
...
- Best-fit role is [[target-forward]] Target Forward with model support score `70`.
- Primary archetype leans toward `Creator` behaviour from a `CF` base.
- Most bankable strengths show up in Blocking, Aerial Duels, and Aggression.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Blocking, Aerial Duels, and Aggression.
