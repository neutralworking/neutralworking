...
Oscar Gimenez projects primarily as a CF with a `None` lean. The strongest database support comes from Creativity, Flair, and Take Ons.

## Role Fit

- Best-fit role is `Target Forward` with model support score `45`.
