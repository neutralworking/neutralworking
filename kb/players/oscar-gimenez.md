...
Oscar Gimenez projects primarily as a CF with a `—` lean. The strongest database support comes from Creativity, Flair, and Take Ons.
...
- Best-fit role is [[target-forward]] Target Forward with model support score `45`.
