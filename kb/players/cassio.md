...
title: Cássio
category: players
tags: [GK, Cruzeiro, Passer]
updated: 2026-04-18
source: compiled
confidence: high
summary: GK at Cruzeiro. Archetype: Passer.
person_id: 1068
backlinks: [passer, cruzeiro]
---
...
Cássio projects primarily as a GK with a `Passer` lean. The strongest database support comes from Reactions, Acceleration, and Close Range.

## Role Fit

- Primary archetype leans toward `Passer` behaviour from a `GK` base.
- Most bankable strengths show up in Reactions, Acceleration, and Close Range.
- Profile should be judged on shot-stopping, area command, and distribution fit to team style.

## In Possession

- Ball-value indicators lean on Reactions, Acceleration, and Close Range.
