...
Mauro Coronel projects primarily as a CD with a `—` lean. The strongest database support comes from Pass Accuracy, Creativity, and Interceptions.
...
- Most bankable strengths show up in Pass Accuracy, Creativity, and Interceptions.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Pass Accuracy, Creativity, and Interceptions.
