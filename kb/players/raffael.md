...
title: Raffael
category: players
tags: [CM, FK Pohronie, Creator]
updated: 2026-04-17
source: compiled
confidence: high
summary: CM at FK Pohronie. Archetype: Creator.
person_id: 6005
backlinks: [creator, fk-pohronie]
---
...
Raffael projects primarily as a CM with a `Creator` lean. The strongest database support comes from Skills, Aggression, and Jumping.

## Role Fit

- Best-fit role is `Playmaker`.
- Primary archetype leans toward `Creator` behaviour from a `CM` base.
- Most bankable strengths show up in Skills, Aggression, and Jumping.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Skills, Aggression, and Jumping.
