...
person_id: 23990
backlinks: [destroyer, tuttocampista, nk-istra-1961]
---
...
D. Marešić projects primarily as a CM with a `Destroyer` lean. The strongest database support comes from Blocking, Pressing, and Awareness.
...
- Most bankable strengths show up in Blocking, Pressing, and Awareness.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Blocking, Pressing, and Awareness.
