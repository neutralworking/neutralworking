...
Catriel Cabellos projects primarily as a CM with a `None` lean. The strongest database support comes from Creativity, Threat, and Through Balls.

## Role Fit

- Best-fit role is `Playmaker` with model support score `30`.
