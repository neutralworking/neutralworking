...
Ahmed Al Nakhli projects primarily as a CM with a `Creator-Cover` lean. The strongest database support comes from Close Range, Concentration, and Creativity.
...
- Most bankable strengths show up in Close Range, Concentration, and Creativity.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Close Range, Concentration, and Creativity.
