...
Kevin Merida projects primarily as a CF with a `None` lean. The strongest database support comes from Pressing, Pass Accuracy, and Communication.

## Role Fit

- Best-fit role is `Falso Nove` with model support score `22`.
- Most bankable strengths show up in Pressing, Pass Accuracy, and Communication.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Pressing, Pass Accuracy, and Communication.
