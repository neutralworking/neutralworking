...
Daniel Calero projects primarily as a CF with a `—` lean. The strongest database support comes from Concentration, Pass Accuracy, and Communication.
...
- Best-fit role is [[falso-nove]] Falso Nove with model support score `32`.
- Most bankable strengths show up in Concentration, Pass Accuracy, and Communication.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Concentration, Pass Accuracy, and Communication.
