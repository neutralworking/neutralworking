...
Daniel Calero projects primarily as a CF with a `None` lean. The strongest database support comes from Concentration, Pass Accuracy, and Communication.

## Role Fit

- Best-fit role is `Falso Nove` with model support score `32`.
