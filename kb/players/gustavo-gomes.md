...
title: Gustavo Gomes
category: players
tags: [CF, Swansea City, Striker]
updated: 2026-04-18
source: compiled
confidence: high
summary: CF at Swansea City. Archetype: Striker.
person_id: 21406
backlinks: [striker, swansea-city]
---
...
Gustavo Gomes projects primarily as a CF with a `Striker` lean. The strongest database support comes from Discipline, Drive, and Concentration.
...
- Best-fit role is `Spearhead` with model support score `19`.
- Primary archetype leans toward `Striker` behaviour from a `CF` base.
- Most bankable strengths show up in Discipline, Drive, and Concentration.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Discipline, Drive, and Concentration.
