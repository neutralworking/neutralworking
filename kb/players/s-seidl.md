...
S. Seidl projects primarily as a WF with a `Creator-Striker` lean. The strongest database support comes from Close Range, Penalties, and Aggression.
...
- Most bankable strengths show up in Close Range, Penalties, and Aggression.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Close Range, Penalties, and Aggression.
