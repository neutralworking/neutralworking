...
Lee Jae-Won projects primarily as a CM with a `Destroyer-Striker` lean. The strongest database support comes from Intensity, Pressing, and Close Range.
...
- Most bankable strengths show up in Intensity, Pressing, and Close Range.

## In Possession

- Ball-value indicators lean on Intensity, Pressing, and Close Range.
