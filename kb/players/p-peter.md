...
title: P. Peter
category: players
tags: [WF, Angers, Cover-Sprinter]
updated: 2026-04-19
source: compiled
confidence: high
summary: WF at Angers. Archetype: Cover-Sprinter.
person_id: 20586
backlinks: [cover, wide-target-forward, angers]
---
...
P. Peter projects primarily as a WF with a `Cover-Sprinter` lean. The strongest database support comes from Acceleration, Balance, and Jumping.
...
- Primary archetype leans toward `Cover` behaviour from a `WF` base.
...
- Style traits point toward Pace, Strength, and Trickery in possession.
