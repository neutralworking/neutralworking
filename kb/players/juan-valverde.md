...
Juan Valverde projects primarily as a CD with a `—` lean. The strongest database support comes from Skills, Blocking, and Pass Accuracy.
...
- Most bankable strengths show up in Skills, Blocking, and Pass Accuracy.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Skills, Blocking, and Pass Accuracy.
