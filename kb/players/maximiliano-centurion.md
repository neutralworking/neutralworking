...
Maximiliano Centurion projects primarily as a CD with a `—` lean. The strongest database support comes from Skills, Blocking, and Concentration.
...
- Best-fit role is [[centrale]] Centrale with model support score `39`.
