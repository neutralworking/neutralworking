...
Gustavo Aguilar projects primarily as a CF with a `—` lean. The strongest database support comes from Concentration, Communication, and Drive.
...
- Best-fit role is [[target-forward]] Target Forward with model support score `34`.
