...
- Best-fit role is [[trequartista]] Trequartista with model support score `26`.
- Primary archetype leans toward `Creator` behaviour from a `AM` base.
- Most bankable strengths show up in Carries, Discipline, and Communication.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Carries, Discipline, and Communication.
