...
A. Banguero projects primarily as a CM with a `Destroyer-Striker` lean. The strongest database support comes from Close Range, Technical, and Blocking.
...
- Most bankable strengths show up in Close Range, Technical, and Blocking.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Close Range, Technical, and Blocking.
