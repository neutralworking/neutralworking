...
Stipe Pletikosa projects primarily as a GK with a `GK` lean. The strongest database support comes from Positioning, Close Range, and Pass Range.
...
- Ball-value indicators lean on Positioning, Close Range, and Pass Range.
