...
title: Tyler Hall
category: players
tags: [CD, Inter Miami CF, United States, Cover]
updated: 2026-04-18
source: compiled
confidence: high
summary: CD at Inter Miami CF. Archetype: Cover.
person_id: 18207
backlinks: [cover, inter-miami-cf]
---
...
Tyler Hall projects primarily as a CD with a `Cover` lean. The strongest database support comes from Pass Accuracy, Shielding, and Acceleration.

## Role Fit

- Primary archetype leans toward `Cover` behaviour from a `CD` base.
- Most bankable strengths show up in Pass Accuracy, Shielding, and Acceleration.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Pass Accuracy, Shielding, and Acceleration.
