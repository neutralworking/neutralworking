...
person_id: 21808
backlinks: [striker, prima-punta, vasco-da-gama]
---
...
P. Vegetti projects primarily as a CF with a `Striker` lean. The strongest database support comes from Penalties, Composure, and Long Range.
...
- Most bankable strengths show up in Penalties, Composure, and Long Range.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Penalties, Composure, and Long Range.
