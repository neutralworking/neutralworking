...
P. Ortíz projects primarily as a CM with a `Destroyer-Striker` lean. The strongest database support comes from Interceptions, Pressing, and Aggression.
...
- Most bankable strengths show up in Interceptions, Pressing, and Aggression.

## In Possession

- Ball-value indicators lean on Interceptions, Pressing, and Aggression.
