...
title: M. Fernández
category: players
tags: [WM, Vélez Sarsfield, Creator-Striker]
updated: 2026-04-17
source: compiled
confidence: high
summary: WM at Vélez Sarsfield. Archetype: Creator-Striker.
person_id: 22548
...
M. Fernández projects primarily as a WM with a `Creator-Striker` lean. The strongest database support comes from Technical, Aggression, and Blocking.

## Role Fit

- Best-fit role is `Tornante` with model support score `69`.
- Primary archetype leans toward `Creator` behaviour from a `WM` base.
- Most bankable strengths show up in Technical, Aggression, and Blocking.

## In Possession

- Ball-value indicators lean on Technical, Aggression, and Blocking.
