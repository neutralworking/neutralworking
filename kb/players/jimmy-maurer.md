...
title: Jimmy Maurer
category: players
tags: [GK, FC Dallas, United States, Dribbler]
updated: 2026-04-18
source: compiled
confidence: high
summary: GK at FC Dallas. Archetype: Dribbler.
person_id: 12641
backlinks: [dribbler, fc-dallas]
---
...
Jimmy Maurer projects primarily as a GK with a `Dribbler` lean. The strongest database support comes from First Touch, Shielding, and Take Ons.

## Role Fit

- Primary archetype leans toward `Dribbler` behaviour from a `GK` base.
- Most bankable strengths show up in First Touch, Shielding, and Take Ons.
- Profile should be judged on shot-stopping, area command, and distribution fit to team style.

## In Possession

- Ball-value indicators lean on First Touch, Shielding, and Take Ons.
