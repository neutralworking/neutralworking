...
person_id: 24212
backlinks: [destroyer, tuttocampista, central-coast-mariners-fc]
---
...
S. Roux projects primarily as a CM with a `Destroyer-Striker` lean. The strongest database support comes from Discipline, Close Range, and Pressing.
...
- Most bankable strengths show up in Discipline, Close Range, and Pressing.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Discipline, Close Range, and Pressing.
