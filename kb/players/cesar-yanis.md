...
César Yanis projects primarily as a CM with a `None` lean. The strongest database support comes from Close Range, First Touch, and Mid Range.

## Role Fit

- Most bankable strengths show up in Close Range, First Touch, and Mid Range.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Close Range, First Touch, and Mid Range.
