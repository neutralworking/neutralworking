...
title: Mikayil Faye
category: players
tags: [CD, Rennes, Senegal, Sprinter-Destroyer]
updated: 2026-04-17
source: compiled
confidence: high
summary: CD at Rennes. Archetype: Sprinter-Destroyer.
person_id: 15184
backlinks: [sprinter, rennes]
---
...
Mikayil Faye projects primarily as a CD with a `Sprinter-Destroyer` lean. The strongest database support comes from Jumping, Acceleration, and Long Range.

## Role Fit

- Best-fit role is `Centrale`.
- Primary archetype leans toward `Sprinter` behaviour from a `CD` base.
- Most bankable strengths show up in Jumping, Acceleration, and Long Range.
- Looks most comfortable when defensive spacing and duel timing matter as much as raw volume.

## In Possession

- Ball-value indicators lean on Jumping, Acceleration, and Long Range.
