...
category: players
tags: [CM, Toronto FC, Canada, Powerhouse]
updated: 2026-04-19
source: compiled
confidence: high
summary: CM at Toronto FC. Archetype: Powerhouse.
person_id: 12872
backlinks: [powerhouse, playmaker, toronto-fc]
---
...
Jonathan Osorio projects primarily as a CM with a `Powerhouse` lean. The strongest database support comes from Balance, Stamina, and Movement.
...
- Best-fit role is [[playmaker]] Playmaker with model support score `38`.
- Primary archetype leans toward `Powerhouse` behaviour from a `CM` base.
- Most bankable strengths show up in Balance, Stamina, and Movement.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Balance, Stamina, and Movement.
