...
L. Abanda projects primarily as a CM with a `Destroyer` lean. The strongest database support comes from Vision, Aggression, and Awareness.
...
- Most bankable strengths show up in Vision, Aggression, and Awareness.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Vision, Aggression, and Awareness.
