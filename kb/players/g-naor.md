...
G. Naor projects primarily as a CM with a `Destroyer` lean. The strongest database support comes from Pass Accuracy, Aggression, and Skills.
...
- Most bankable strengths show up in Pass Accuracy, Aggression, and Skills.

## In Possession

- Ball-value indicators lean on Pass Accuracy, Aggression, and Skills.
