...
title: Romaric
category: players
tags: [CM, Northeast United FC, Destroyer]
updated: 2026-04-18
source: compiled
confidence: high
summary: CM at Northeast United FC. Archetype: Destroyer.
person_id: 6289
backlinks: [destroyer, northeast-united-fc]
---
...
Romaric projects primarily as a CM with a `Destroyer` lean. The strongest database support comes from Pass Accuracy, Long Range, and Mid Range.

## Role Fit

- Best-fit role is `Playmaker`.
- Primary archetype leans toward `Destroyer` behaviour from a `CM` base.
- Most bankable strengths show up in Pass Accuracy, Long Range, and Mid Range.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Pass Accuracy, Long Range, and Mid Range.
