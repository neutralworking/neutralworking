...
Freddy Roca Vivancos projects primarily as a CF with a `—` lean. The strongest database support comes from Pass Accuracy, Discipline, and Communication.
...
- Best-fit role is [[falso-nove]] Falso Nove with model support score `18`.
- Most bankable strengths show up in Pass Accuracy, Discipline, and Communication.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Pass Accuracy, Discipline, and Communication.
