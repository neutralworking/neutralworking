...
Freddy Roca Vivancos projects primarily as a CF with a `None` lean. The strongest database support comes from Pass Accuracy, Discipline, and Communication.

## Role Fit

- Best-fit role is `Falso Nove` with model support score `18`.
