...
source: compiled
confidence: high
summary: GK at Caen. Archetype: GK.
person_id: 6063
backlinks: [gk, sweeper-keeper, caen]
---
...
Rémy Vercoutre projects primarily as a GK with a `GK` lean. The strongest database support comes from Reactions, Close Range, and Pass Range.
