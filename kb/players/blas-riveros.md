...
Blas Riveros projects primarily as a CD with a `—` lean. The strongest database support comes from Discipline, Awareness, and Composure.
...
- Best-fit role is [[sweeper]] Sweeper with model support score `47`.
