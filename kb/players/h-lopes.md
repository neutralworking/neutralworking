...
person_id: 24588
backlinks: [destroyer, mezzala, aguilas-doradas]
---
...
H. Lópes projects primarily as a CM with a `Destroyer-Striker` lean. The strongest database support comes from Blocking, Long Range, and Technical.
...
- Most bankable strengths show up in Blocking, Long Range, and Technical.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Blocking, Long Range, and Technical.
