...
João Loiola projects primarily as a CM with a `Cover` lean. The strongest database support comes from Discipline, Blocking, and Interceptions.
...
- Most bankable strengths show up in Discipline, Blocking, and Interceptions.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Discipline, Blocking, and Interceptions.
