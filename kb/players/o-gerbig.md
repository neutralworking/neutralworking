...
O. Gerbig projects primarily as a CM with a `Destroyer-Creator` lean. The strongest database support comes from Blocking, Discipline, and Pass Accuracy.
...
- Ball-value indicators lean on Blocking, Discipline, and Pass Accuracy.
