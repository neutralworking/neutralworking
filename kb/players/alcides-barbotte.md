...
Alcides Barbotte projects primarily as a CD with a `None` lean. The strongest database support comes from Skills, Communication, and Concentration.

## Role Fit

- Best-fit role is `Colossus` with model support score `37`.
