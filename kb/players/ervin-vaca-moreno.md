...
Ervin Vaca Moreno projects primarily as a CF with a `—` lean. The strongest database support comes from Pass Accuracy, Composure, and Pressing.
...
- Best-fit role is [[target-forward]] Target Forward with model support score `47`.
- Most bankable strengths show up in Pass Accuracy, Composure, and Pressing.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Pass Accuracy, Composure, and Pressing.
