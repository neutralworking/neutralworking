...
Pedro Villalba projects primarily as a CF with a `None` lean. The strongest database support comes from Take Ons, Flair, and Pressing.

## Role Fit

- Best-fit role is `Target Forward` with model support score `37`.
