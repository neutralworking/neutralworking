...
title: J. Fuentes
category: players
tags: [CF, UMECIT FC, Cover-Striker]
updated: 2026-04-18
source: compiled
confidence: high
summary: CF at UMECIT FC. Archetype: Cover-Striker.
person_id: 26246
backlinks: [cover, spearhead, umecit-fc]
---
...
J. Fuentes projects primarily as a CF with a `Cover-Striker` lean. The strongest database support comes from Awareness, First Touch, and Interceptions.
...
- Best-fit role is [[spearhead]] Spearhead with model support score `45`.
- Primary archetype leans toward `Cover` behaviour from a `CF` base.
- Most bankable strengths show up in Awareness, First Touch, and Interceptions.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Awareness, First Touch, and Interceptions.
- Style traits point toward Strength, Work Rate, and Tackling Ability in possession.
