...
G. Flores projects primarily as a CM with a `Destroyer` lean. The strongest database support comes from Blocking, Pressing, and Communication.
...
- Most bankable strengths show up in Blocking, Pressing, and Communication.
- Fits systems that value repeat involvement in build-up and defensive transitions.

## In Possession

- Ball-value indicators lean on Blocking, Pressing, and Communication.
