...
Derlis Rodriguez projects primarily as a CF with a `—` lean. The strongest database support comes from Creativity, Close Range, and Mid Range.
...
- Most bankable strengths show up in Creativity, Close Range, and Mid Range.
- Best used in roles that preserve final-third touches rather than heavy circulation duties.

## In Possession

- Ball-value indicators lean on Creativity, Close Range, and Mid Range.
