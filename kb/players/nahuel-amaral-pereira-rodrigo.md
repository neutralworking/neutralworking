---
title: Nahuel Amaral Pereira Rodrigo
category: players
tags: [CM, Bolivia]
updated: 2026-04-17
source: compiled
...
Nahuel Amaral Pereira Rodrigo projects primarily as a CM with a `None` lean. The strongest database support comes from Threat, Close Range, and Long Range.

## Role Fit

- Best-fit role is `Mezzala` with model support score `32`.
